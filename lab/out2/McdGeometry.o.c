...
MeBool __regparm3 McdGeometryIsValid(McdGeometryID g)

{
  ...
  if (in_stack_00000004 != (undefined1 *)0x0) {
    MVar1 = McdFrameworkTypeIsValid(*(undefined4 *)(in_stack_00000004 + 0xc),*in_stack_00000004);
  }
  return MVar1;
}
...

{
  ...
  pcVar1 = (char *)McdFrameworkGetTypeName(g->frame,(char)g->mRefCtAndID);
  return pcVar1;
}
...
void __regparm1 McdGeometryDestroy(McdGeometryID g)

{
  ...
  if (uVar1 >> 8 != 0) {
    MeWarning(0,"Destroying geometry with non-zero reference count!",g,g,g);
    uVar1 = *in_stack_00000004;
  }
  (**(code **)(*(int *)(in_stack_00000004[3] + 0x18) + (uVar1 & 0xff) * 0x28))();
  return;
}
