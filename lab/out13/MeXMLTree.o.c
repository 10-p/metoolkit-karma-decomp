...

{
  ...
  pAVar1 = (*_MeMemoryAPI)(8);
  pAVar2 = (*_MeMemoryAPI)(8);
  sVar3 = strlen(attr);
  pcVar4 = (*_MeMemoryAPI)(sVar3 + 1);
  pAVar1->attr = pcVar4;
  strcpy(pcVar4,attr);
  sVar3 = strlen(val);
  pcVar4 = (*_MeMemoryAPI)(sVar3 + 1);
...
LAB_000104e0:
      ...
      if (!bVar2) {
        return;
                    ...
                    /* Unresolved local var: Attribute * at@[DW_OP_reg3(EBX)]
                       Unresolved local var: AttributeNode * node@[DW_OP_reg7(EDI)] */
      pAVar4 = (*_MeMemoryAPI)(8);
      pAVar5 = (*_MeMemoryAPI)(8);
      sVar6 = strlen(pcVar7);
      pcVar8 = (*_MeMemoryAPI)(sVar6 + 1);
      pAVar4->attr = pcVar8;
      strcpy(pcVar8,pcVar7);
      sVar6 = strlen(val);
      pcVar7 = (*_MeMemoryAPI)(sVar6 + 1);
      pAVar4->value = pcVar7;
      strcpy(pcVar7,val);
