...
void keaFunctions::makejlenandbl2body
               (int *jlen_12padded,int *jlen,int (*bl2body_12padded) [8],int (*bl2body) [8],
               int (*bl2cbody) [8],int (*Jbody) [2],int *Jsize,int *num_rows_inc_padding_partition,
               int *num_rows_exc_padding_partition,int *num_constraints_partition,
               int num_constraints,int num_partitions)

{
  ...
  if (in_stack_00000034 != 0) {
    do {
      if (0 < *(int *)(num_constraints + partition * 4)) {
        uVar5 = num_constraints_partition[partition];
        if ((uVar5 & 3) == 0) {
          uVar1 = uVar5;
          if ((int)uVar5 < 0) {
            uVar1 = uVar5 + 3;
        ...
        iVar3 = num_rows_exc_padding_partition[partition];
        if (iVar3 < 0) {
          iVar3 = iVar3 + 3;
        }
        if ((int)uVar5 % 0xc == 0) {
        ...
        singPartmakejlenandbl2body
                  (&constraint,*bl2body_12padded,bl2cbody,(int (*) [8])Jbody,(int (*) [2])Jsize,
                   num_rows_inc_padding_partition,iVar3 >> 2,num_strips_00,num_partitions);
        iVar3 = 0;
        if (num_strips_00 != 0) {
          do {
            jlen[iVar3] = (*bl2body_12padded)[iVar3];
            iVar7 = iVar3 + 1;
            bl2body[iVar3][0] = bl2cbody[iVar3][0];
            bl2body[iVar3][1] = bl2cbody[iVar3][1];
            bl2body[iVar3][2] = bl2cbody[iVar3][2];
            bl2body[iVar3][3] = bl2cbody[iVar3][3];
            bl2body[iVar3][4] = bl2cbody[iVar3][4];
            bl2body[iVar3][5] = bl2cbody[iVar3][5];
            bl2body[iVar3][6] = bl2cbody[iVar3][6];
            bl2body[iVar3][7] = bl2cbody[iVar3][7];
            iVar3 = iVar7;
          } while (iVar7 != num_strips_00);
        }
        jlen = jlen + iVar2;
        bl2body = bl2body + iVar2;
        bl2body_12padded = (int (*) [8])(*bl2body_12padded + num_strips_00);
        Jbody = Jbody + num_strips_00 * 4;
        bl2cbody = bl2cbody + num_strips_00;
      }
      partition = partition + 1;
    } while (partition != in_stack_00000034);
  }
  return;
}
