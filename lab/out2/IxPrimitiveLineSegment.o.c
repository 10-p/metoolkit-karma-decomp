...

{
  ...
  uVar11 = McdModelGetGeometry(model);
  pfVar12 = (float *)McdModelGetTransformPtr(model);
  ...
  pMVar13 = (MeReal *)McdBoxGetRadii(uVar11);
  minB.v[0] = -*pMVar13;
  inMaxB.v[0] = *pMVar13;
  minB.v[1] = -pMVar13[1];
...

{
  ...
  uVar6 = McdModelGetGeometry(model);
  iVar7 = McdModelGetTransformPtr(model);
  fVar3 = *(float *)(iVar7 + 0x30);
  fVar4 = *(float *)(iVar7 + 0x34);
  fVar5 = *(float *)(iVar7 + 0x38);
  lVar8 = (longdouble)McdSphereGetRadius(uVar6);
  lVar17 = lVar8 * lVar8;
  lVar9 = (longdouble)*inDest - (longdouble)*inOrig;
  lVar10 = (longdouble)inDest[1] - (longdouble)inOrig[1];
  lVar11 = (longdouble)inDest[2] - (longdouble)inOrig[2];
  lVar12 = SQRT(lVar9 * lVar9 + lVar10 * lVar10 + lVar11 * lVar11);
  if (lVar12 < (longdouble)1e-06) {
    return 0;
  }
  lVar13 = (longdouble)0;
  if (lVar12 != lVar13) {
    lVar13 = (longdouble)1 / lVar12;
  }
  fVar1 = inOrig[1];
  lVar14 = (longdouble)fVar3 - (longdouble)*inOrig;
  lVar15 = (longdouble)fVar4 - (longdouble)fVar1;
  fVar2 = inOrig[2];
  lVar16 = (longdouble)fVar5 - (longdouble)fVar2;
  lVar18 = (longdouble)(float)lVar9 * lVar13 * lVar14 + (longdouble)(float)lVar10 * lVar13 * lVar15
           + (longdouble)(float)lVar11 * lVar13 * lVar16;
  lVar14 = lVar16 * lVar16 + lVar14 * lVar14 + lVar15 * lVar15;
  if (lVar17 <= lVar14) {
    if ((lVar18 < (longdouble)0) && (lVar17 < lVar14)) {
      return 0;
    }
    lVar14 = lVar14 - lVar18 * lVar18;
    if (lVar17 < lVar14) {
      return 0;
    }
                    /* Unresolved local var: float __result@[???] */
    lVar18 = lVar18 - SQRT(lVar17 - lVar14);
    if (lVar12 < lVar18) {
      return 0;
    }
    info->position[0] =
         (float)((longdouble)(float)((longdouble)(float)lVar9 * lVar13) * lVar18 +
                (longdouble)*inOrig);
    info->position[1] =
         (float)((longdouble)(float)((longdouble)(float)lVar10 * lVar13) * lVar18 +
                (longdouble)fVar1);
    info->position[2] =
         (float)((longdouble)(float)((longdouble)(float)lVar11 * lVar13) * lVar18 +
                (longdouble)fVar2);
    fVar1 = 0.0;
    if ((float)lVar8 != 0.0) {
      fVar1 = 1.0 / (float)lVar8;
    }
                    /* Unresolved local var: int i@[???] */
    info->normal[0] = (info->position[0] - fVar3) * fVar1;
    info->normal[1] = (info->position[1] - fVar4) * fVar1;
    info->distance = (float)lVar18;
    info->normal[2] = (info->position[2] - fVar5) * fVar1;
  }
  else {
    info->distance = 0.0;
...

{
  ...
  pfVar9 = (float *)McdModelGetTransformPtr(model);
...
{
  McdFrameworkSetLineSegInteraction(frame,2,0x10000);
  return;
}
