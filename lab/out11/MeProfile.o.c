...

{
  ...
  if (output.style == kMeProfileOutputEvent) {
    ...
    puVar8 = (*_MeProfileGetTimerValue)(uVar13,8);
    puVar9 = (*_MeProfileGetTimerValue)(uVar13,8);
    uVar7 = 0;
    puVar10 = (*_MeProfileGetTimerValue)(uVar13,8);
    puVar6 = (*_MeProfileGetTimerValue)(uVar13,8);
    pMVar2 = firstfd;
    if (nSections != 0) {
      uVar13 = nSections & 3;
      if (nSections < 2) {
...
joined_r0x00010efd:
    for (; pMVar2 != (MeProfileFrameData *)0x0; pMVar2 = pMVar2->next) {
      ...
      cyclesAllFrames._0_4_ = (uint)cyclesAllFrames + uVar13;
      ...
      count0AllFrames._0_4_ = (uint)count0AllFrames + uVar13;
      ...
      count1AllFrames._0_4_ = (uint)count1AllFrames + uVar13;
  ...
  uVar13 = 0;
  puVar6 = (*_MeProfileGetTimerValue)(nSections << 3,8);
  total._0_4_ = 0;
  total._4_4_ = 0;
...
joined_r0x0001099b:
  for (; pMVar2 != (MeProfileFrameData *)0x0; pMVar2 = pMVar2->next) {
    ...
    for (pMVar3 = pMVar2->firstfsi; pMVar3 != (MeProfileFrameSectionInfo *)0x0;
      ...
      *puVar1 = *puVar1 + uVar7;
      ...
      sectionsTotal._0_4_ = (uint)sectionsTotal + uVar13;
      sectionsTotal._4_4_ =
  ...
  __udivdi3((uint)sectionsTotal,sectionsTotal._4_4_,nFrames);
  __udivdi3((uint)total,total._4_4_,nFrames);
...

{
  ...
  p_Var12 = (*_MeProfileDestroyHardwareTimer)(0x24);
  tailWD->next = p_Var12;
  thisfd = firstfd;
