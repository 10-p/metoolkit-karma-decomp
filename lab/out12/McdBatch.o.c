...

{
  ...
  do {
    (*_DAT_0001203c)(*(void **)((int)&context->pools->contacts + iVar2));
    (*_DAT_0001203c)(*(void **)((int)&context->pools[1].contacts + iVar2));
    (*_DAT_0001203c)(*(void **)((int)&context->pools[2].contacts + iVar2));
    puVar1 = (undefined4 *)((int)&context->pools[3].contacts + iVar2);
    iVar2 = iVar2 + 0x30;
    (*_DAT_0001203c)((void *)*puVar1);
    iVar3 = iVar3 + -4;
  } while (-1 < iVar3);
