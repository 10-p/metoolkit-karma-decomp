...
LAB_0001043c:
    ...
    (*(code *)*_vanillaQMatrix)(&vanillaQMatrix,numClamped);
    (*(code *)_vanillaQMatrix[2])
              (&vanillaQMatrix,this->Qrhs,this->Ainv,this->clampedValues,this->initialSolve,
               unclamped,clamped,numUnclamped,numClamped,this->AinvStride);
    (*(code *)_vanillaQMatrix[3])(&vanillaQMatrix);
    (*(code *)_vanillaQMatrix[4])(&vanillaQMatrix,this->Qrhs,this->Qrhs);
...

{
  ...
  (*(code *)*_vanillaQMatrix)(&vanillaQMatrix,numClamped);
  (*(code *)_vanillaQMatrix[2])
            (&vanillaQMatrix,this->Qrhs,this->Ainv,this->clampedValues,this->initialSolve,unclamped,
             clamped,numUnclamped,numClamped,this->AinvStride);
  (*(code *)_vanillaQMatrix[3])(&vanillaQMatrix);
  (*(code *)_vanillaQMatrix[4])(&vanillaQMatrix,this->Qrhs,this->Qrhs);
  (**(code **)(*(int *)this->A + 0x20))(this->A);
  PrincipalPivotTransformMakeW(this,this->w,this->Qrhs,clamped,unclamped,numClamped,numUnclamped);
