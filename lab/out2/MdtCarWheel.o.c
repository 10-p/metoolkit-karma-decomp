...

{
  ...
  pMVar1 = (MdtCarWheelID)BaseConstraintCreate(w);
  pMVar3 = (MdtCarWheelID)0x0;
  if (pMVar1 != (MdtCarWheelID)0x0) {
                    /* Unresolved local var: MdtConstraintID c@[???] */
    (pMVar1->head).tag = 3;
    (pMVar1->head).bclFunction = (MdtBclAddConstraintFn)&MdtBclAddCarWheel;
    ...
    MdtConstraintBodySetAxesRel(pMVar1,0,0,0,0x3f800000,0,0x3f800000,0);
    MdtConstraintBodySetAxesRel(pMVar1,1,0,0,0x3f800000,0,0x3f800000,0);
    pMVar1->skp = 0.0;
    pMVar1->skd = 0.0;
    pMVar1->svel = 0.0;
    pMVar1->sfmax = 1e+09;
...

{
  ...
  (j->head).ref1[3][1] = 0.0;
  (j->head).ref1[3][2] = 0.0;
  MdtConstraintBodySetAxesRel(j,0,0,0,0x3f800000,0,0x3f800000,0);
  MdtConstraintBodySetAxesRel(j,1,0,0,0x3f800000,0,0x3f800000,0);
  j->skp = 0.0;
  j->skd = 0.0;
  j->svel = 0.0;
  j->sfmax = 1e+09;
...

{
  ...
  MdtConvertVector((j->head).mdtbody[0],(j->head).ref1,0,sa);
...
void __regparm1 MdtCarWheelGetSteeringAxis(MdtCarWheelID j,MeReal *v)

{
  MdtConvertVector(v[0x15],v + 0x2f,0);
  return;
}
...

{
  ...
  MdtConvertVector((j->head).mdtbody[0],(j->head).ref1,0,s1);
  MdtConvertVector((j->head).mdtbody[1],(j->head).ref2,0,s2);
...
void __regparm1 MdtCarWheelGetHingeAxis(MdtCarWheelID j,MeReal *v)

{
  MdtConvertVector(v[0x16],v + 0x43,0);
  return;
}
