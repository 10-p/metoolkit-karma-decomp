 ...
 * source object: /home/ion/tools/karma-lab/allobj/MovingBoxBoxIntersect.o
 */
#include "kd_compat.h"
#include "kd_karma.h"
#include "kd_types.h"
...
/*  Prelude for MovingBoxBoxIntersect.o — generated by tools/gen_prelude.py.
 *
...
void kd_printV3(char *str,lsVec3 *V3) KD_MANGLED("_Z7printV3PcRK6lsVec3");
uint kd_MovingBoxBoxIntersect (MeReal *ExtBox0,lsTransform *tm0,lsVec3 *V0,MeReal *ExtBox1,lsTransform *tm1, lsVec3 *V1,MeReal dt,MeReal *T,lsVec3 *P) KD_MANGLED("_Z21MovingBoxBoxIntersectPKfPK11lsTransformRK6lsVec3S0_S3_S6_fRfRS4_");
...
/* ---- printV3 (exported as kd_printV3, asm label "kd_printV3") ---- */
void kd_printV3(char *str,lsVec3 *V3)
...
/* ---- MovingBoxBoxIntersect (exported as kd_MovingBoxBoxIntersect, asm label "kd_MovingBoxBoxIntersect") ---- */
uint kd_MovingBoxBoxIntersect
