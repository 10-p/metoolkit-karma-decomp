...

{
  ...
  iVar9 = McdModelGetTransformPtr(p->model1);
  iVar10 = McdModelGetTransformPtr(p->model2);
  lVar12 = (longdouble)McdModelGetContactTolerance(p->model1);
  lVar13 = (longdouble)McdModelGetContactTolerance(p->model2);
  iVar11 = McdModelGetGeometry(p->model1);
  McdModelGetGeometry(p->model2);
  result->contactCount = 0;
  result->touch = 0;
  fVar1 = *(float *)(iVar9 + 0x20);
  fVar5 = *(float *)(iVar10 + 0x28) * *(float *)(iVar9 + 0x28) +
          fVar1 * *(float *)(iVar10 + 0x20) + *(float *)(iVar10 + 0x24) * *(float *)(iVar9 + 0x24);
  ds = 0.0;
  if (-0.001 <= fVar5) {
    fVar2 = -*(float *)(iVar11 + 0x14);
    end[0] = fVar1 * fVar2 + *(float *)(iVar9 + 0x30);
    end[1] = fVar2 * *(float *)(iVar9 + 0x24) + *(float *)(iVar9 + 0x34);
    end[2] = fVar2 * *(float *)(iVar9 + 0x28) + *(float *)(iVar9 + 0x38);
    if (fVar5 < 0.001) {
      ds = *(float *)(iVar11 + 0x14) + *(float *)(iVar11 + 0x14);
    }
  }
  else {
    fVar2 = *(float *)(iVar11 + 0x14);
  ...
  fVar1 = ((end[2] - *(float *)(iVar10 + 0x38)) * *(float *)(iVar10 + 0x28) +
          (end[1] - *(float *)(iVar10 + 0x34)) * *(float *)(iVar10 + 0x24) +
          (end[0] - *(float *)(iVar10 + 0x30)) * *(float *)(iVar10 + 0x20)) -
          *(float *)(iVar11 + 0x10);
  if ((float)(lVar13 + (longdouble)(float)lVar12) <= fVar1) goto LAB_000103ca;
  fVar2 = -*(float *)(iVar11 + 0x10) - fVar1;
  pos[0] = end[0] + *(float *)(iVar10 + 0x20) * fVar2;
  pos[1] = fVar2 * *(float *)(iVar10 + 0x24) + end[1];
  pos[2] = fVar2 * *(float *)(iVar10 + 0x28) + end[2];
  result->normal[0] = 0.0;
  result->normal[1] = 0.0;
  result->normal[2] = 0.0;
  AccumulateSphylContacts
            (pos,(MeReal *)(iVar10 + 0x20),fVar1,3,2,(MeVector3Ptr)(iVar9 + 0x20),ds,
             (MeMatrix4Ptr)0x0,result);
  if (ds != 0.0) goto LAB_000103ca;
  fVar2 = *(float *)(iVar10 + 0x20);
  fVar3 = *(float *)(iVar11 + 0x10);
  fVar8 = fVar3 - ((*(float *)(iVar9 + 0x30) * fVar2 +
                    *(float *)(iVar9 + 0x34) * *(float *)(iVar10 + 0x24) +
                   *(float *)(iVar9 + 0x38) * *(float *)(iVar10 + 0x28)) -
                  (*(float *)(iVar10 + 0x30) * fVar2 +
                   *(float *)(iVar10 + 0x24) * *(float *)(iVar10 + 0x34) +
                  *(float *)(iVar10 + 0x28) * *(float *)(iVar10 + 0x38)));
...
LAB_000104fd:
    s = fVar4;
    if ((fVar8 < fVar6 * fVar4) && (s = fVar7, fVar3 * fVar5 * fVar5 <= fVar8 - fVar7 * fVar5)) {
      s = fVar8 / fVar5;
    }
  }
  else if (fVar5 < 0.00025) {
    fVar6 = -fVar5;
    goto LAB_000104fd;
  }
  if (s != fVar7) {
    fVar3 = -fVar3;
    pos2[0] = s * *(float *)(iVar9 + 0x20) + fVar3 * fVar2 + *(float *)(iVar9 + 0x30);
    pos2[1] = s * *(float *)(iVar9 + 0x24) +
              fVar3 * *(float *)(iVar10 + 0x24) + *(float *)(iVar9 + 0x34);
    pos2[2] = s * *(float *)(iVar9 + 0x28) +
              fVar3 * *(float *)(iVar10 + 0x28) + *(float *)(iVar9 + 0x38);
    result->normal[0] = 0.0;
    result->normal[1] = 0.0;
    result->normal[2] = 0.0;
    AccumulateSphylContacts
              (pos2,(MeReal *)(iVar10 + 0x20),fVar1,3,2,(MeVector3Ptr)0x0,0.0,(MeMatrix4Ptr)0x0,
               result);
  }
LAB_000103ca:
  return result->touch;
...

{
  ...
  iVar11 = McdModelGetTransformPtr(p->model2);
  lVar15 = (longdouble)McdModelGetContactTolerance(p->model1);
  lVar16 = (longdouble)McdModelGetContactTolerance(p->model2);
  iVar12 = McdModelGetGeometry(p->model1);
  iVar13 = McdModelGetGeometry(p->model2);
  pMVar1 = p->model1->frame;
  result->contactCount = 0;
  result->touch = 0;
  fVar2 = *(float *)(iVar12 + 0x14);
  fVar3 = (*(float *)(iVar11 + 0x30) - *(float *)(iVar10 + 0x30)) * *(float *)(iVar10 + 0x20) +
          (*(float *)(iVar11 + 0x34) - *(float *)(iVar10 + 0x34)) * *(float *)(iVar10 + 0x24) +
          (*(float *)(iVar11 + 0x38) - *(float *)(iVar10 + 0x38)) * *(float *)(iVar10 + 0x28);
  fVar4 = -fVar2;
  if (fVar3 < fVar2) {
    fVar2 = fVar3;
  }
  ...
  fVar9 = fVar2 * *(MeVector3Ptr)(iVar10 + 0x20) + *(float *)(iVar10 + 0x30);
  fVar8 = fVar2 * *(float *)(iVar10 + 0x24) + *(float *)(iVar10 + 0x34);
  fVar3 = fVar2 * *(float *)(iVar10 + 0x28) + *(float *)(iVar10 + 0x38);
  fVar6 = fVar9 - *(float *)(iVar11 + 0x30);
  fVar7 = fVar8 - *(float *)(iVar11 + 0x34);
  fVar4 = fVar3 - *(float *)(iVar11 + 0x38);
  fVar5 = fVar4 * fVar4 + fVar6 * fVar6 + fVar7 * fVar7;
  fVar2 = pMVar1->mScale;
  if (fVar5 <= fVar2 * fVar2 * 6.250001e-08) {
                    /* Unresolved local var: MeI32 i@[???] */
    pos[0] = *(float *)(iVar10 + 0x20) * *(float *)(iVar10 + 0x20);
    pos[1] = *(float *)(iVar10 + 0x24) * *(float *)(iVar10 + 0x24);
    pos[2] = *(float *)(iVar10 + 0x28) * *(float *)(iVar10 + 0x28);
    ...
    n[0] = *(float *)(iVar10 + 0x24) * aa[2] - *(float *)(iVar10 + 0x28) * aa[1];
    n[1] = *(float *)(iVar10 + 0x28) * aa[0] - aa[2] * *(float *)(iVar10 + 0x20);
    n[2] = aa[1] * *(float *)(iVar10 + 0x20) - aa[0] * *(float *)(iVar10 + 0x24);
  ...
  fVar2 = fVar2 - (*(float *)(iVar12 + 0x10) + *(float *)(iVar13 + 0x10));
  if (fVar2 < (float)(lVar16 + (longdouble)(float)lVar15)) {
    fVar4 = -*(float *)(iVar12 + 0x10) - fVar2;
    ...
    result->normal[2] = 0.0;
    AccumulateSphylContacts
              (pos,n,fVar2,3,3,(MeVector3Ptr)(iVar10 + 0x20),0.0,(MeMatrix4Ptr)0x0,result);
  }
  return result->touch;
}
...

{
  ...
  iVar8 = McdModelGetTransformPtr(p->model1);
  iVar9 = McdModelGetTransformPtr(p->model2);
  lVar14 = (longdouble)McdModelGetContactTolerance(p->model1);
  lVar15 = (longdouble)McdModelGetContactTolerance(p->model2);
  iVar10 = McdModelGetGeometry(p->model1);
  iVar11 = McdModelGetGeometry(p->model2);
  result->contactCount = 0;
  result->touch = 0;
  iVar12 = NSegmentNSegment((float *)(iVar8 + 0x30),(float *)(iVar8 + 0x20),
                            -*(float *)(iVar10 + 0x14),*(float *)(iVar10 + 0x14),
                            (float *)(iVar9 + 0x30),(float *)(iVar9 + 0x20),
                            -*(float *)(iVar11 + 0x14),*(float *)(iVar11 + 0x14),&s,&t,&ds);
  fVar6 = t * *(float *)(iVar9 + 0x20) + *(float *)(iVar9 + 0x30);
  fVar7 = (s * *(float *)(iVar8 + 0x20) + *(float *)(iVar8 + 0x30)) - fVar6;
  fVar4 = t * *(float *)(iVar9 + 0x24) + *(float *)(iVar9 + 0x34);
  fVar3 = (s * *(float *)(iVar8 + 0x24) + *(float *)(iVar8 + 0x34)) - fVar4;
  fVar5 = t * *(float *)(iVar9 + 0x28) + *(float *)(iVar9 + 0x38);
  fVar1 = (s * *(float *)(iVar8 + 0x28) + *(float *)(iVar8 + 0x38)) - fVar5;
  local_ac = fVar1 * fVar1 + fVar7 * fVar7 + fVar3 * fVar3;
  if (local_ac <= 6.250001e-08) {
    if (iVar12 == 0) {
                    /* Unresolved local var: MeI32 i@[???]
                       Unresolved local var: MeI32 index@[DW_OP_reg0(EAX)] */
      p_1[0] = *(float *)(iVar8 + 0x20) * *(float *)(iVar8 + 0x20);
      p_1[1] = *(float *)(iVar8 + 0x24) * *(float *)(iVar8 + 0x24);
      p_1[2] = *(float *)(iVar8 + 0x28) * *(float *)(iVar8 + 0x28);
      ...
      n[0] = *(float *)(iVar8 + 0x24) * aa[2] - *(float *)(iVar8 + 0x28) * aa[1];
      n[1] = *(float *)(iVar8 + 0x28) * aa[0] - aa[2] * *(float *)(iVar8 + 0x20);
      n[2] = aa[1] * *(float *)(iVar8 + 0x20) - aa[0] * *(float *)(iVar8 + 0x24);
    }
    else {
      n[0] = *(float *)(iVar9 + 0x28) * *(float *)(iVar8 + 0x24) -
             *(float *)(iVar9 + 0x24) * *(float *)(iVar8 + 0x28);
      n[1] = *(float *)(iVar9 + 0x20) * *(float *)(iVar8 + 0x28) -
             *(float *)(iVar9 + 0x28) * *(float *)(iVar8 + 0x20);
      n[2] = *(float *)(iVar9 + 0x24) * *(float *)(iVar8 + 0x20) -
             *(float *)(iVar9 + 0x20) * *(float *)(iVar8 + 0x24);
    }
    local_ac = 0.0;
    MeVector3Normalize(n);
  }
  ...
  local_ac = local_ac - (*(float *)(iVar10 + 0x10) + fVar1);
  if (local_ac < (float)(lVar15 + (longdouble)(float)lVar14)) {
    ...
    result->normal[1] = 0.0;
    result->normal[2] = 0.0;
    AccumulateSphylContacts(p_1,n,local_ac,3,3,(float *)(iVar8 + 0x20),ds,(MeMatrix4Ptr)0x0,result);
  }
  return result->touch;
}
...

{
  ...
  iVar8 = McdModelGetTransformPtr(p->model1);
  tm = (MeMatrix4Ptr)McdModelGetTransformPtr(p->model2);
  lVar16 = (longdouble)McdModelGetContactTolerance(p->model1);
  lVar17 = (longdouble)McdModelGetContactTolerance(p->model2);
  uVar15 = 0;
  iVar9 = McdModelGetGeometry(p->model1);
  iVar10 = McdModelGetGeometry(p->model2);
  result->contactCount = 0;
  result->touch = 0;
  relAxis[0] = (*tm)[2] * *(float *)(iVar8 + 0x28) +
               (*tm)[1] * *(float *)(iVar8 + 0x24) + (*tm)[0] * *(float *)(iVar8 + 0x20);
  relAxis[1] = tm[1][2] * *(float *)(iVar8 + 0x28) +
               tm[1][1] * *(float *)(iVar8 + 0x24) + tm[1][0] * *(float *)(iVar8 + 0x20);
  relAxis[2] = tm[2][2] * *(float *)(iVar8 + 0x28) +
               tm[2][1] * *(float *)(iVar8 + 0x24) + tm[2][0] * *(float *)(iVar8 + 0x20);
  fVar3 = *(float *)(iVar8 + 0x30) - tm[3][0];
  boxP[1] = *(float *)(iVar8 + 0x34) - tm[3][1];
  boxP[2] = *(float *)(iVar8 + 0x38) - tm[3][2];
  ...
  if (ABS(relAxis[0]) <= 0.00025) {
    ...
    si[0] = (-*(float *)(iVar10 + 0x10) - relPos[0]) * (1.0 / relAxis[0]);
    si[1] = (1.0 / relAxis[0]) * (*(float *)(iVar10 + 0x10) - relPos[0]);
    if (relAxis[0] < 0.0) {
      signN = 1;
    }
  }
  boxP[0] = *(float *)(iVar10 + 0x10);
  if (-boxP[0] <= pos[0]) {
    if (pos[0] <= boxP[0]) {
      uVar15 = 1;
      boxP[0] = 0.0;
  ...
  do {
    ...
    if (ABS(fVar3) <= 0.00025) {
      ...
      fVar4 = relPos[iVar12];
      si[iVar12 * 2] = (-*(float *)(iVar10 + 0x10 + iVar12 * 4) - fVar4) * (1.0 / fVar3);
      si[iVar12 * 2 + 1] = (*(float *)(iVar10 + 0x10 + iVar12 * 4) - fVar4) * (1.0 / fVar3);
      if (fVar3 < 0.0) {
        signN = signN | 1 << ((byte)iVar12 & 0x1f);
      }
    }
    fVar3 = *(float *)(iVar10 + 0x10 + iVar12 * 4);
    if (-fVar3 <= pos[iVar12]) {
      if (pos[iVar12] <= fVar3) {
        uVar15 = uVar15 + 1;
        MVar7 = iVar12;
    ...
    if (ABS(fVar3) <= 0.00025) {
      ...
      fVar4 = relPos[iVar1];
      si[iVar1 * 2] = (-*(float *)(iVar10 + 0x10 + iVar1 * 4) - fVar4) * (1.0 / fVar3);
      si[iVar1 * 2 + 1] = (*(float *)(iVar10 + 0x10 + iVar1 * 4) - fVar4) * (1.0 / fVar3);
      if (fVar3 < 0.0) {
        signN = signN | 1 << ((byte)iVar1 & 0x1f);
      }
    }
    fVar3 = *(float *)(iVar10 + 0x10 + iVar1 * 4);
    if (-fVar3 <= pos[iVar1]) {
      if (pos[iVar1] <= fVar3) {
        uVar15 = uVar15 + 1;
        MVar7 = iVar1;
...
LAB_00011567:
      if (jMin < 7) {
        ...
        if (fVar3 <= 6.250001e-08) {
          ...
          fVar3 = *(float *)(iVar9 + 0x14);
          fVar4 = -3.4028235e+38;
          fVar6 = ABS(relPos[0]) - (ABS(relAxis[0]) * fVar3 + *(float *)(iVar10 + 0x10));
          if ((-3.4028235e+38 < fVar6) && (fVar4 = fVar6, relPos[0] <= 0.0)) {
            sepSign = -1.0;
          }
          fVar6 = ABS(relPos[1]) - (ABS(relAxis[1]) * fVar3 + *(float *)(iVar10 + 0x14));
          if (fVar4 < fVar6) {
            sepIndex = 1;
            sepSign = 1.0;
            fVar4 = fVar6;
          ...
          fVar3 = ABS(relPos[2]) - (ABS(relAxis[2]) * fVar3 + *(float *)(iVar10 + 0x18));
          if (fVar4 < fVar3) {
            sepIndex = 2;
            sepSign = 1.0;
            fVar4 = fVar3;
          ...
          do {
            ...
            if (6.250001e-08 < fVar3) {
              ...
              fVar3 = ABS(fVar6) -
                      (ABS(d[2]) * *(float *)(iVar10 + 0x18) +
                      ABS(d[0]) * *(float *)(iVar10 + 0x10) + ABS(d[1]) * *(float *)(iVar10 + 0x14))
              ;
              if (fVar4 < fVar3) {
                sepIndex = iVar12 + 3;
                n[0] = d[0];
          ...
          n[1] = n[1] * fVar4;
          n[2] = n[2] * fVar4;
          fVar4 = fVar3 * fVar4 - *(float *)(iVar9 + 0x10);
        }
        if (fVar4 < (float)(lVar17 + (longdouble)(float)lVar16)) {
          result->normal[0] = 0.0;
          result->normal[1] = 0.0;
          result->normal[2] = 0.0;
          AccumulateSphylContacts(boxP,n,fVar4,3,boxDim,(MeVector3Ptr)(iVar8 + 0x20),ds1,tm,result);
        }
      }
      goto LAB_00011498;
    }
...
LAB_000114d0:
      ...
      uVar15 = uVar15 - 1;
      boxP[iVar12] = (float)(int)((uVar14 & 1) * 2 + -1) * *(float *)(iVar10 + 0x10 + iVar12 * 4);
      if (uVar15 != 1) {
...

{
  ...
  MeReal relAxis [3];
                    ...
                    /* Unresolved local var: int i@[DW_OP_reg2(EDX)]
                       ...
                       Unresolved local var: MeReal n2@[???]
                       Unresolved local var: MeReal sep@[DW_OP_reg11(ST0)] */
  iVar13 = McdModelGetTransformPtr(p->model1);
  tm = (MeMatrix4Ptr)McdModelGetTransformPtr(p->model2);
  lVar24 = (longdouble)McdModelGetContactTolerance(p->model1);
  lVar25 = (longdouble)McdModelGetContactTolerance(p->model2);
  iVar14 = McdModelGetGeometry(p->model1);
  iVar15 = McdModelGetGeometry(p->model2);
  result->contactCount = 0;
  result->touch = 0;
  fVar4 = (*tm)[2] * *(float *)(iVar13 + 0x28) +
          (*tm)[1] * *(float *)(iVar13 + 0x24) + (*tm)[0] * *(float *)(iVar13 + 0x20);
  p_1[0] = tm[1][2] * *(float *)(iVar13 + 0x28) +
           tm[1][1] * *(float *)(iVar13 + 0x24) + tm[1][0] * *(float *)(iVar13 + 0x20);
  fVar5 = tm[2][2] * *(float *)(iVar13 + 0x28) +
          tm[2][1] * *(float *)(iVar13 + 0x24) + tm[2][0] * *(float *)(iVar13 + 0x20);
  fVar6 = *(float *)(iVar13 + 0x30) - tm[3][0];
  fVar3 = *(float *)(iVar13 + 0x34) - tm[3][1];
  fVar22 = *(float *)(iVar13 + 0x38) - tm[3][2];
  ...
  if (ABS(fVar5) <= 0.00025) {
    ...
    fVar2 = (float)iVar1 * *(float *)(iVar15 + 0x14);
  ...
  if (6.250001e-08 < fVar3) {
    ...
    fVar9 = fVar2 * fVar2 -
            ((fVar7 * fVar7 + fVar8 * fVar8) - *(float *)(iVar15 + 0x10) * *(float *)(iVar15 + 0x10)
            ) * fVar3;
    if (0.0 <= fVar9) {
  ...
  si[3] = 3.4028235e+38;
LAB_000122c2:
  if (fVar22 * fVar22 + fVar20 * fVar20 <= *(float *)(iVar15 + 0x10) * *(float *)(iVar15 + 0x10)) {
...
LAB_00012aea:
        if ((int)uVar17 < 5) {
          ...
          if (fVar3 <= 6.250001e-08) {
                    /* Unresolved local var: MeReal a2@[DW_OP_reg12(ST1)]
                       ...
                       Unresolved local var: MeReal sepI@[DW_OP_reg11(ST0)] */
            maxSep = ABS(fVar6) -
                     (ABS(fVar5) * *(float *)(iVar14 + 0x14) + *(float *)(iVar15 + 0x14));
            if (fVar6 <= 0.0) {
              n[2] = -1.0;
            }
            else {
            ...
            fVar5 = ABS(fVar4) - *(float *)(iVar15 + 0x10);
            if ((maxSep < fVar5) &&
            ...
            fVar4 = maxSep - *(float *)(iVar14 + 0x10);
          }
          else {
                    /* Unresolved local var: MeReal invN@[DW_OP_reg11(ST0)]
                       Unresolved local var: float __result@[DW_OP_reg11(ST0)] */
            ...
            n[1] = n[1] * fVar4;
            n[2] = n[2] * fVar4;
            fVar4 = fVar3 * fVar4 - *(float *)(iVar14 + 0x10);
          }
          if (fVar4 < (float)(lVar25 + (longdouble)(float)lVar24)) {
            result->normal[0] = 0.0;
            result->normal[1] = 0.0;
            result->normal[2] = 0.0;
            AccumulateSphylContacts
                      (cylP,n,fVar4,3,cylDim,(MeVector3Ptr)(iVar13 + 0x20),ds1,tm,result);
          }
          return result->touch;
        }
        break;
      ...
      if (regionType != 0) {
        ...
        if (fVar20 <= 0.00025) {
          ...
          cylP[0] = cylP[0] * *(float *)(iVar15 + 0x10);
          cylP[2] = n[2];
          cylP[1] = *(float *)(iVar15 + 0x10) * cylP[1];
          n[2] = 0.0;
          n[0] = n[0] - cylP[0];
          n[1] = n[1] - cylP[1];
          fVar3 = *(float *)(iVar14 + 0x14);
...
LAB_00012a54:
        ...
        if (fVar2 <= 6.250001e-08) {
          fVar22 = (*(float *)(iVar15 + 0x14) - fVar6) * fVar5;
          if (fVar22 < fVar3) {
            fVar20 = fVar22;
          }
          if (fVar20 < -fVar3) {
          ...
          fVar10 = *(float *)(iVar15 + 0x10) * *(float *)(iVar15 + 0x10);
          ...
          if (0 < (int)uVar18) {
            if (((int)uVar18 < 2) || ((uVar18 & 1) != 0)) {
              ...
              fVar3 = SQRT(fVar3 * fVar3 + fVar20 * fVar20) - *(float *)(iVar15 + 0x10);
            ...
            do {
              ...
              fVar3 = SQRT(fVar2 * fVar2 + fVar22 * fVar22) - *(float *)(iVar15 + 0x10);
              ...
              fVar22 = SQRT(fVar20 * fVar20 + fVar22 * fVar22) - *(float *)(iVar15 + 0x10);
...
LAB_00012991:
      ...
      if ((uVar16 & 1) == 0) {
        ...
        if (iVar19 == 0) {
          cylZ = (float)iVar1 * *(float *)(iVar15 + 0x14);
        }
      }
      uVar17 = uVar17 + 1;
    } while ((int)uVar17 < 5);
...

{
  ...
  int aiStack_80 [4];
  float fStack_70;
  McdModelID_conflict apMStack_6c [2];
  MeReal aMStack_64 [2];
  int local_5c;
  MeReal *local_58;
  ...
  MeReal relAxis [3];
                    ...
                    /* Unresolved local var: MeMatrix4Ptr tm1@[DW_OP_reg3(EBX)]
                       ...
                       Unresolved local var: MeReal n2@[???] */
  apMStack_6c[0] = p->model1;
  fStack_70 = 1.11302e-40;
  iVar6 = McdModelGetTransformPtr();
  apMStack_6c[0] = p->model2;
  fStack_70 = 1.11323e-40;
  pfVar7 = (float *)McdModelGetTransformPtr();
  apMStack_6c[0] = p->model1;
  fStack_70 = 1.11343e-40;
  lVar14 = (longdouble)McdModelGetContactTolerance();
  eps = (MeReal)lVar14;
  apMStack_6c[0] = p->model2;
  fStack_70 = 1.11365e-40;
  lVar14 = (longdouble)McdModelGetContactTolerance();
  eps = (MeReal)(lVar14 + (longdouble)eps);
  apMStack_6c[0] = p->model1;
  fStack_70 = 1.11391e-40;
  iVar8 = McdModelGetGeometry();
  apMStack_6c[0] = p->model2;
  fStack_70 = 1.11412e-40;
  pMVar9 = (McdTriangleListID)McdModelGetGeometry();
  result->contactCount = 0;
  result->touch = 0;
  relAxis[0] = pfVar7[2] * *(float *)(iVar6 + 0x28) +
               pfVar7[1] * *(float *)(iVar6 + 0x24) + *pfVar7 * *(float *)(iVar6 + 0x20);
  relAxis[1] = pfVar7[6] * *(float *)(iVar6 + 0x28) +
               pfVar7[5] * *(float *)(iVar6 + 0x24) + pfVar7[4] * *(float *)(iVar6 + 0x20);
  relAxis[2] = pfVar7[10] * *(float *)(iVar6 + 0x28) +
               pfVar7[9] * *(float *)(iVar6 + 0x24) + pfVar7[8] * *(float *)(iVar6 + 0x20);
  tmp[0] = *(float *)(iVar6 + 0x30) - pfVar7[0xc];
  tmp[1] = *(float *)(iVar6 + 0x34) - pfVar7[0xd];
  tmp[2] = *(float *)(iVar6 + 0x38) - pfVar7[0xe];
  ...
  pMVar2 = pMVar9[2].next;
  iVar6 = -((int)pMVar2 * 0x18 + 0xfU & 0xfffffff0);
  pMVar9[3].prev = (McdGeometryID)((int)&stack0xffffffa4 + iVar6);
  trilistGeom = pMVar9;
  *(McdGeometryID *)((int)apMStack_6c + iVar6) = pMVar2;
  *(float *)((int)&fStack_70 + iVar6) = *(float *)(iVar8 + 0x10) + *(float *)(iVar8 + 0x14) + eps;
  *(MeReal **)((int)aiStack_80 + iVar6 + 0xc) = relPos;
  *(McdGeometryID *)((int)aiStack_80 + iVar6 + 8) = pMVar9[3].prev;
  pMVar9 = trilistGeom;
  *(McdModelPair **)((int)aiStack_80 + iVar6 + 4) = p;
  pcVar3 = (code *)pMVar9[3].mRefCtAndID;
  *(undefined4 *)((int)aiStack_80 + iVar6) = 0x137af;
  iVar10 = (*pcVar3)();
  MVar5 = eps;
  puVar13 = (undefined1 *)((int)&stack0xffffffa4 + iVar6);
  puVar12 = (undefined1 *)((int)&stack0xffffffa4 + iVar6);
  if (iVar10 == 0) {
    return 0;
  }
  ...
  if (0 < iVar10) {
    ...
    if (uVar11 != 0) {
      ...
      if (uVar11 < 3) {
        if (uVar11 < 2) {
          *(McdIntersectResult **)((int)aMStack_64 + iVar6 + 4) = result;
          iVar10 = iVar10 + -1;
          *(MeReal *)((int)aMStack_64 + iVar6) = MVar5;
          *(float **)((int)apMStack_6c + iVar6 + 4) = pfVar7;
          *(undefined4 *)((int)apMStack_6c + iVar6) = *(undefined4 *)(iVar8 + 0x10);
          *(undefined4 *)((int)&fStack_70 + iVar6) = *(undefined4 *)(iVar8 + 0x14);
          pMVar9 = trilistGeom;
          *(MeReal **)((int)aiStack_80 + iVar6 + 0xc) = relAxis;
          *(MeReal **)((int)aiStack_80 + iVar6 + 8) = relPos;
          *(McdGeometryID *)((int)aiStack_80 + iVar6 + 4) = pMVar9[3].prev;
          *(undefined4 *)((int)aiStack_80 + iVar6) = 0x139dc;
          GenerateTriangleContact
                    (*(McdUserTriangle **)((int)aiStack_80 + iVar6 + 4),
                     *(MeReal **)((int)aiStack_80 + iVar6 + 8),
                     *(MeReal **)((int)aiStack_80 + iVar6 + 0xc),
                     *(MeReal *)((int)&fStack_70 + iVar6),*(MeReal *)((int)apMStack_6c + iVar6),
                     *(MeVector4 **)((int)apMStack_6c + iVar6 + 4),
                     *(MeReal *)((int)aMStack_64 + iVar6),
                     *(McdIntersectResult **)((int)aMStack_64 + iVar6 + 4));
          puVar12 = (undefined1 *)((int)&stack0xffffffa4 + iVar6);
          local_5c = 0x18;
        }
        MVar5 = eps;
        ...
        *(undefined4 *)(puVar12 + -0x10) = *(undefined4 *)(iVar8 + 0x10);
        *(undefined4 *)(puVar12 + -0x14) = *(undefined4 *)(iVar8 + 0x14);
        pMVar9 = trilistGeom;
        *(MeReal **)(puVar12 + -0x18) = relAxis;
        iVar6 = local_5c;
        *(MeReal **)(puVar12 + -0x1c) = relPos;
        *(int *)(puVar12 + -0x20) = (int)&(pMVar9[3].prev)->mRefCtAndID + iVar6;
      ...
      *(undefined4 *)(puVar13 + -0x10) = *(undefined4 *)(iVar8 + 0x10);
      *(undefined4 *)(puVar13 + -0x14) = *(undefined4 *)(iVar8 + 0x14);
      pMVar9 = trilistGeom;
    ...
    do {
      ...
      *(MeReal **)(puVar13 + -0x18) = relAxis;
      iVar6 = local_5c;
      *(MeReal **)(puVar13 + -0x1c) = relPos;
      *(int *)(puVar13 + -0x20) = (int)&pMVar9[3].prev[1].next + iVar6;
      ...
      *(MeReal **)(puVar13 + -0x18) = relAxis;
      iVar6 = local_5c;
      *(MeReal **)(puVar13 + -0x1c) = relPos;
      *(int *)(puVar13 + -0x20) = (int)&pMVar9[3].prev[3].mRefCtAndID + iVar6;
      ...
      *(MeReal **)(puVar13 + -0x18) = relAxis;
      iVar6 = local_5c;
      *(MeReal **)(puVar13 + -0x1c) = relPos;
      *(int *)(puVar13 + -0x20) = (int)&pMVar9[3].prev[4].next + iVar6;
...
LAB_0001394c:
  ...
  fVar4 = local_58[2] * local_58[2] + fVar1 * fVar1 + local_58[1] * local_58[1];
...

{
  ...
  iVar9 = McdModelGetGeometry(model);
  pfVar10 = (float *)McdModelGetTransformPtr(model);
  ...
  bVar7 = false;
  if (lOrig[2] < *(float *)(iVar9 + 0x14)) {
    if (-*(float *)(iVar9 + 0x14) <= lOrig[2]) {
    ...
    bVar7 = true;
    if ((-*(float *)(iVar9 + 0x14) <= fVar2) && (bVar8 = true, *(float *)(iVar9 + 0x14) <= fVar2)) {
      bVar3 = true;
    }
  }
  else {
    bVar3 = true;
    if (fVar2 < *(float *)(iVar9 + 0x14)) {
      fVar1 = *(float *)(iVar9 + 0x14);
joined_r0x00014225:
      bVar8 = true;
      if (fVar2 < -fVar1) {
  ...
  uVar12 = 0;
  if (bVar3) {
    sp[2] = *(MeReal *)(iVar9 + 0x14);
    uVar11 = LineSphere(sp,*(MeReal *)(iVar9 + 0x10),lOrig,dir,mag,&tmpInfo);
    uVar12 = 0;
    if (uVar11 != 0) {
      uVar12 = uVar11 & (tmpInfo.position[2] < *(float *)(iVar9 + 0x14)) - 1;
    }
  }
  if ((bVar7) && (uVar12 == 0)) {
    sp[2] = -*(MeReal *)(iVar9 + 0x14);
    ...
    uVar12 = 0;
    if (uVar11 != 0) {
      uVar12 = uVar11 & (-*(float *)(iVar9 + 0x14) < tmpInfo.position[2]) - 1;
    }
  }
  if (bVar8) {
    ...
    if (((fVar2 * fVar2 < lOrig[0] * lOrig[0] + lOrig[1] * lOrig[1]) ||
        (*(float *)(iVar9 + 0x14) < lOrig[2])) || (lOrig[2] < -*(float *)(iVar9 + 0x14))) {
      ...
      if ((0.0 <= fVar2) && (1e-12 < ABS(fVar5))) {
        ...
        if (((0.0 < fVar2) && ((fVar2 < mag && (fVar4 <= *(float *)(iVar9 + 0x14))))) &&
           (-*(float *)(iVar9 + 0x14) <= fVar4)) {
