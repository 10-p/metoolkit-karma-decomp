...

{
  ...
  strtok(buffer," ");
  ptVar1 = (tagNode *)(*_MeMemoryAPI)(0xc);
  puVar3 = (uint *)buffer;
  do {
    puVar2 = puVar3;
    puVar3 = puVar2 + 1;
  ...
  __dest = (char *)(*_MeMemoryAPI)((char *)((int)puVar3 +
                                           (-(int)buffer - (uint)CARRY1((byte)uVar5,(byte)uVar5)) +
                                           -2));
  ptVar1->tag = __dest;
...

{
  ...
  pMVar1 = (MeXMLOutput *)(*_MeMemoryAPI)(0xc);
