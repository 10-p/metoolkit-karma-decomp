...

{
  ...
  iVar5 = -uVar19;
  *(uint *)((int)aiStack_4c + iVar5 + -4) = uVar19;
  *(uint *)(&stack0xffffffac + iVar5) = uVar19;
  ...
  if (0 < count) {
    do {
      ...
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1031c;
      pvVar13 = MeFAssetPartGetModel(*(void **)(&stack0xffffffa4 + iVar5));
      *(void **)(&stack0xffffffa4 + iVar5) = pvVar13;
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10326;
      pvVar14 = MeFModelGetGeometry(*(void **)(&stack0xffffffa4 + iVar5));
      *(void **)(&stack0xffffffa4 + iVar5) = pvVar13;
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10330;
      iVar17 = MeFModelGetType(*(void **)(&stack0xffffffa4 + iVar5));
      pMVar8 = ins;
      iVar17 = iVar17 + -1;
      if ((iVar17 == 0) || (pvVar14 == (void *)0x0)) {
        ...
        *(int *)((int)aiStack_4c + iVar5 + -4) = iVar17;
        *(int *)(&stack0xffffffac + iVar5) = iVar17;
        *(MeHash **)(&stack0xffffffa8 + iVar5) = pMVar8->nameToGeometry;
        *(void **)(&stack0xffffffa4 + iVar5) = pvVar14;
        *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10351;
        pvVar13 = MeFGeometryGetName(*(void **)(&stack0xffffffa4 + iVar5));
        *(void **)(&stack0xffffffa4 + iVar5) = pvVar13;
      ...
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10373;
      sVar12 = strlen(*(char **)(&stack0xffffffa4 + iVar5));
      *(size_t *)(&stack0xffffffa4 + iVar5) = sVar12 + 1;
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1037d;
      pvVar14 = (*_MeMemoryAPI)(*(uint *)(&stack0xffffffa4 + iVar5));
      ...
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1038a;
      ...
      pMVar16 = (McdModelID_conflict)0x0;
      pMVar21 = af;
      if (p_Var3 != (ModelCreateFunc)0x0) {
        ...
        *(McdGeometryID *)(&stack0xffffffa8 + iVar5) = pMVar11;
        pMVar21 = *(MeAssetFactory **)((int)aiStack_4c + iVar17 * 4 + iVar5);
        *(MeAssetFactory **)(&stack0xffffffa4 + iVar5) = pMVar21;
        *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x104e4;
        pMVar16 = (*p_Var3)(*(MeFAssetPart **)(&stack0xffffffa4 + iVar5),
                            *(McdGeometryID *)(&stack0xffffffa8 + iVar5),
                            *(MdtWorldID *)(&stack0xffffffac + iVar5),
                            *(MeMatrix4Ptr *)((int)aiStack_4c + iVar5 + -4));
        model = pMVar16;
      }
      *(McdModelID_conflict *)((int)aiStack_4c + iVar5 + -4) = pMVar16;
      *(McdModelID_conflict *)(&stack0xffffffac + iVar5) = pMVar16;
      ...
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x103aa;
      ...
      if (p_Var4 != (ModelPostCreateCB)0x0) {
        *(MeAssetFactory **)((int)aiStack_4c + iVar5 + -4) = pMVar21;
        iVar17 = i;
        *(void **)(&stack0xffffffac + iVar5) = af->modelPostCreateCBUserdata;
        pMVar16 = model;
        *(undefined4 *)(&stack0xffffffa8 + iVar5) =
             *(undefined4 *)((int)aiStack_4c + iVar17 * 4 + iVar5);
        *(McdModelID_conflict *)(&stack0xffffffa4 + iVar5) = pMVar16;
      ...
      pMVar8 = ins;
      *(undefined4 *)((int)aiStack_4c + iVar5 + -4) = uVar20;
      pMVar16 = model;
      *(MeHash **)(&stack0xffffffac + iVar5) = pMVar8->nameToModel;
      *(McdModelID_conflict *)(&stack0xffffffa8 + iVar5) = pMVar16;
      *(void **)(&stack0xffffffa4 + iVar5) = pvVar14;
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x103cd;
      pvVar13 = MeHashInsert(*(void **)(&stack0xffffffa4 + iVar5),
                             *(void **)(&stack0xffffffa8 + iVar5),
    ...
    if (0 < count) {
      do {
        ...
        if (iVar17 < count) {
          do {
            *(void **)((int)aiStack_4c + iVar5 + -4) = pvVar13;
            ...
            *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10425;
            ...
            if (pvVar13 == (void *)0x0) {
              ...
              *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1046e;
              pvVar14 = MeHashLookup(*(void **)(&stack0xffffffa4 + iVar5),
                                     *(void **)(&stack0xffffffa8 + iVar5));
              pvVar13 = pvVar14;
              if ((model1_1 != (McdModelID_conflict)0x0) && (pvVar14 != (void *)0x0)) {
                *(McdModelID_conflict *)(&stack0xffffffa4 + iVar5) = model1_1;
                *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1048a;
                pvVar18 = McdModelGetSpace(*(void **)(&stack0xffffffa4 + iVar5));
                pvVar13 = (void *)0x0;
                if (pvVar18 != (void *)0x0) {
                  *(void **)(&stack0xffffffa4 + iVar5) = pvVar14;
                  *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x1049a;
                  ...
                  pvVar13 = (void *)0x0;
                  if (pvVar18 != (void *)0x0) {
                    *(void **)((int)aiStack_4c + iVar5 + -4) = pvVar18;
                    *(void **)(&stack0xffffffac + iVar5) = pvVar18;
                    pMVar16 = model1_1;
                    *(void **)(&stack0xffffffa8 + iVar5) = pvVar14;
                    *(McdModelID_conflict *)(&stack0xffffffa4 + iVar5) = pMVar16;
                    *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x104ad;
                    pvVar13 = (void *)McdSpaceDisablePair(*(void **)(&stack0xffffffa4 + iVar5),
                                                          *(void **)(&stack0xffffffa8 + iVar5));
                  }
                }
              }
...
LAB_000101a0:
  ...
  *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x101ac;
  pvVar13 = MeFAssetGetJoint(*(void **)(&stack0xffffffa4 + iVar5));
  if (pvVar13 == (void *)0x0) {
    return ins;
  }
  *(void **)((int)aiStack_4c + iVar5 + -4) = pvVar13;
  ...
  *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x101d1;
  pvVar14 = MeFJointGetPart(*(void **)(&stack0xffffffa4 + iVar5),*(int *)(&stack0xffffffa8 + iVar5))
  ;
  *(undefined4 *)(&stack0xffffffa8 + iVar5) = 1;
  *(void **)(&stack0xffffffa4 + iVar5) = pvVar13;
  *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x101dd;
  pMVar15 = MeFJointGetPart(*(void **)(&stack0xffffffa4 + iVar5),*(int *)(&stack0xffffffa8 + iVar5))
  ;
  pMVar8 = ins;
  pMVar16 = pMVar15;
  if (pvVar14 != (void *)0x0) {
    ...
    *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x101f5;
    pvVar14 = MeFAssetPartGetName(*(void **)(&stack0xffffffa4 + iVar5));
    *(void **)(&stack0xffffffa4 + iVar5) = pvVar14;
    *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x101fd;
    pMVar16 = MeHashLookup(*(void **)(&stack0xffffffa4 + iVar5),*(void **)(&stack0xffffffa8 + iVar5)
                          );
    model1 = pMVar16;
  }
  if (pMVar15 != (McdModelID_conflict)0x0) {
    *(McdModelID_conflict *)((int)aiStack_4c + iVar5 + -4) = pMVar16;
    *(McdModelID_conflict *)(&stack0xffffffac + iVar5) = pMVar16;
    *(MeHash **)(&stack0xffffffa8 + iVar5) = ins->nameToModel;
  ...
  *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10237;
  pvVar14 = McdModelGetBody(*(void **)(&stack0xffffffa4 + iVar5));
...
LAB_00010260:
      ...
      if (p_Var1 != (JointCreateFunc)0x0) {
        ...
        *(McdModelID_conflict *)((int)auStackY_70 + iVar5 + 0x10) = pMVar16;
        *(McdModelID_conflict *)((int)auStackY_70 + iVar5 + 0xc) = pMVar15;
        *(MdtWorldID *)((int)auStackY_70 + iVar5 + 8) = world;
        *(void **)((int)auStackY_70 + iVar5 + 4) = pvVar13;
      ...
      if (pvVar14 != (void *)0x0) {
        *(undefined4 *)((int)aiStack_4c + iVar5 + -4) = uVar20;
        *(void **)(&stack0xffffffac + iVar5) = pvVar14;
        pMVar6 = constraint;
        *(void **)(&stack0xffffffa8 + iVar5) = pvVar13;
      ...
      *(undefined4 *)((int)auStackY_70 + iVar5 + 0x10) = 0x10293;
      pvVar13 = MeFJointGetName(*(void **)(&stack0xffffffa4 + iVar5));
      *(void **)(&stack0xffffffa4 + iVar5) = pvVar13;
