...

{
  ...
  if (ins->child != (_McdGeometryInstance *)0x0) {
    ...
    uVar13 = McdGeometryGetFramework(ins->mGeometry);
    p_Var10 = (McdGeometryInstanceID)((ulonglong)uVar13 >> 0x20);
    if (ins->child != (_McdGeometryInstance *)0x0) {
      p_Var5 = ins->child;
      do {
        p_Var7 = p_Var5->next;
        frame = (McdFrameworkID)p_Var5->child;
        while (frame != (McdFrameworkID)0x0) {
          ...
          McdGeometryInstanceDestroy(frame,p_Var10);
          frame = pMVar1;
          p_Var10 = extraout_EDX;
        }
        uVar9 = 0;
        if (p_Var5->mGeometry != (McdGeometry *)0x0) {
          uVar9 = McdGeometryDecrementReferenceCount(p_Var5->mGeometry);
        }
        (*_DAT_0001101c)((int)uVar13 + 0x60,p_Var5,uVar9,uVar9);
        p_Var10 = extraout_EDX_00;
        p_Var5 = p_Var7;
  ...
  iVar4 = McdGeometryGetFramework(geom);
                    /* Unresolved local var: McdGeometryInstance * ins@[DW_OP_reg0(EAX)] */
  iVar4 = iVar4 + 0x60;
  p_Var5 = (_McdGeometryInstance *)(*___gxx_personality_v0)(iVar4);
  ...
  if (0 < (int)uVar6) {
    ...
    if ((uVar6 & 1) != 0) {
      ...
      p_Var7 = (_McdGeometryInstance *)(*___gxx_personality_v0)(iVar4);
...
LAB_00010362:
  ...
  if (1 < (int)uVar3) {
    ...
    if (1 < uVar6) {
      ...
      if (bVar2) {
        ...
        pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,0,ins,ins);
      ...
      uVar12 = (uint)bVar2;
      iVar4 = uVar12 + 1;
      pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,uVar12,uVar6,uVar6);
      McdGeometryInstanceSetGeometry(p_Var5,pMVar8);
      p_Var5 = p_Var5->next;
  ...
  iVar11 = iVar4 + 1;
  pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,iVar4,uVar6,uVar6);
  McdGeometryInstanceSetGeometry(p_Var5,pMVar8);
  p_Var5 = p_Var5->next;
  uVar9 = extraout_EAX;
  iVar4 = iVar11;
...
LAB_000103a8:
  do {
    pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,iVar4,uVar9,uVar9);
    McdGeometryInstanceSetGeometry(p_Var5,pMVar8);
    p_Var10 = p_Var5->next;
    pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,iVar4 + 1);
    McdGeometryInstanceSetGeometry(p_Var10,pMVar8);
    p_Var10 = p_Var10->next;
    pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,iVar4 + 2);
    iVar11 = iVar4 + 3;
    iVar4 = iVar4 + 4;
    McdGeometryInstanceSetGeometry(p_Var10,pMVar8);
    p_Var10 = p_Var10->next;
    pMVar8 = (McdGeometryID)McdAggregateGetElementGeometry(geom,iVar11);
    McdGeometryInstanceSetGeometry(p_Var10,pMVar8);
    p_Var5 = p_Var10->next;
...

{
  ...
  if (*in_stack_00000008 != 0) {
    McdGeometryDecrementReferenceCount(*in_stack_00000008);
  }
