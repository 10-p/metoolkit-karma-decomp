...

{
  ...
  pMVar1 = (MdtContactGroupID_conflict)BaseConstraintCreate(w);
  ...
  if (pMVar1 != (MdtContactGroupID_conflict)0x0) {
    ...
    (pMVar1->head).tag = 5;
    (pMVar1->head).bclFunction = (MdtBclAddConstraintFn)&MdtBclAddContactGroup;
    ...
    if (pMVar6 != pMVar4) {
      do {
        uVar3 = MdtContactQuaConstraint(pMVar6);
        iVar2 = MdtConstraintIsEnabled(uVar3);
        if (iVar2 != 0) {
          uVar3 = MdtContactQuaConstraint(pMVar6);
          MdtConstraintDisable(uVar3);
        }
        pMVar4 = (MdtContactID_conflict)MdtContactGetNext(pMVar6);
        uVar3 = MdtContactQuaConstraint(pMVar6);
        MdtConstraintDestroy(uVar3);
        pMVar6 = pMVar4;
...

{
  ...
  while (pMVar3 != (MdtContactID_conflict)0x0) {
    ...
    uVar4 = MdtContactQuaConstraint(pMVar3);
    MdtConstraintDestroy(uVar4);
    pMVar3 = pMVar1;
  }
...

{
  ...
  if (pMVar4 != _MdtContactInvalidID) {
    do {
      uVar2 = MdtContactQuaConstraint(pMVar4);
      iVar1 = MdtConstraintIsEnabled(uVar2);
      if (iVar1 != 0) {
        uVar2 = MdtContactQuaConstraint(pMVar4);
        MdtConstraintDisable(uVar2);
      }
      pMVar3 = (MdtContactID_conflict)MdtContactGetNext(pMVar4);
      uVar2 = MdtContactQuaConstraint(pMVar4);
      MdtConstraintDestroy(uVar2);
      pMVar4 = pMVar3;
...

{
  ...
  pMVar2 = (MdtContactID_conflict)MdtContactCreate((g->head).world);
  if (pMVar2 != _MdtContactInvalidID) {
    ...
    g->count = g->count + 1;
    uVar3 = MdtContactQuaConstraint(pMVar2,(g->head).mdtbody[0],(g->head).mdtbody[1],pMVar1);
    MdtConstraintSetBodies(uVar3);
  }
  return pMVar2;
}
