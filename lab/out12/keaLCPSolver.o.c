...

{
  ...
  (*___gxx_personality_v0)(this_00,numUnclamped);
  _ZN18keaMatrix_pcSparse19makeFromPcSparsePSMEPfPKS_PKfS4_PKiS6_iii
            (this_00,this->Qrhs,this->A,b,this->clampedValues,unclamped,clamped,numUnclamped,
             numClamped,this->n_blocks);
  (**(code **)(_vanillaQMatrix + 0xc))(this_00);
  (**(code **)(_vanillaQMatrix + 0x10))(this_00,this->Qrhs,this->Qrhs);
...
LAB_0001070e:
      ...
      iVar5 = iVar5 + 1;
      (&this_00->AinvStride)[*piVar2] = (int)this->clampedValues[*piVar2];
    ...
    do {
      ...
      this_00 = (keaLCPSolver *)this->x;
      iVar5 = iVar5 + 4;
      (&this_00->AinvStride)[clamped[iVar1]] = (int)this->clampedValues[clamped[iVar1]];
...
LAB_00010794:
    ...
    iVar5 = iVar5 + 1;
    (&this_00->AinvStride)[*piVar2] = (int)*pMVar4;
