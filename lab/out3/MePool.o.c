...
void * __regparm2 MePoolMallocGetStruct(MePool *u)

{
  ...
  if (*(int *)(in_stack_00000004 + 4) < *(int *)(in_stack_00000004 + 0xc)) {
                    /* Unresolved local var: void * p@[DW_OP_reg0(EAX)] */
    if (*(int *)(in_stack_00000004 + 0x10) == 0) {
      pvVar1 = (void *)(*_MeMemoryAPI)(*(undefined4 *)(in_stack_00000004 + 8));
    }
    else {
      pvVar1 = (void *)(*_MeWarning)(*(undefined4 *)(in_stack_00000004 + 8),
