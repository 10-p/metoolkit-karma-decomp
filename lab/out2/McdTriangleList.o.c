...

{
  ...
  pfVar10 = (float *)McdGeometryInstanceGetTransformPtr(ins);
  local_60 = ABS(*pfVar10);
  fVar1 = ABS(pfVar10[8]) * *(float *)(iVar9 + 0x24) +
          ABS(pfVar10[4]) * *(float *)(iVar9 + 0x20) + local_60 * *(float *)(iVar9 + 0x1c);
  local_64 = ABS(pfVar10[1]);
  fVar2 = ABS(pfVar10[9]) * *(float *)(iVar9 + 0x24) +
          ABS(pfVar10[5]) * *(float *)(iVar9 + 0x20) + local_64 * *(float *)(iVar9 + 0x1c);
  fVar3 = ABS(pfVar10[10]) * *(float *)(iVar9 + 0x24) +
          ABS(pfVar10[6]) * *(float *)(iVar9 + 0x20) + ABS(pfVar10[2]) * *(float *)(iVar9 + 0x1c);
  fVar5 = pfVar10[8] * *(float *)(iVar9 + 0x18) +
          pfVar10[4] * *(float *)(iVar9 + 0x14) + *pfVar10 * *(float *)(iVar9 + 0x10) + pfVar10[0xc]
  ;
  fVar6 = pfVar10[9] * *(float *)(iVar9 + 0x18) +
          pfVar10[5] * *(float *)(iVar9 + 0x14) + pfVar10[1] * *(float *)(iVar9 + 0x10) +
          pfVar10[0xd];
  fVar4 = pfVar10[10] * *(float *)(iVar9 + 0x18) +
          pfVar10[6] * *(float *)(iVar9 + 0x14) + pfVar10[2] * *(float *)(iVar9 + 0x10) +
          pfVar10[0xe];
  ...
  if (finalTM != (MeMatrix4Ptr)0x0) {
    fVar3 = finalTM[2][0] * *(float *)(iVar9 + 0x18) +
            finalTM[1][0] * *(float *)(iVar9 + 0x14) + *(float *)(iVar9 + 0x10) * (*finalTM)[0] +
            finalTM[3][0];
    fVar2 = finalTM[2][1] * *(float *)(iVar9 + 0x18) +
            *(float *)(iVar9 + 0x14) * finalTM[1][1] + *(float *)(iVar9 + 0x10) * (*finalTM)[1] +
            finalTM[3][1];
    fVar8 = *(float *)(iVar9 + 0x10) * (*finalTM)[2] + *(float *)(iVar9 + 0x14) * finalTM[1][2] +
            *(float *)(iVar9 + 0x18) * finalTM[2][2] + finalTM[3][2];
    local_68 = ABS(finalTM[1][0]);
    local_6c = ABS(finalTM[2][0]);
    fVar1 = local_6c * *(float *)(iVar9 + 0x24) +
            local_68 * *(float *)(iVar9 + 0x20) + ABS((*finalTM)[0]) * *(float *)(iVar9 + 0x1c);
    local_74 = ABS(finalTM[2][1]);
    fVar4 = local_74 * *(float *)(iVar9 + 0x24) +
            ABS((*finalTM)[1]) * *(float *)(iVar9 + 0x1c) +
            ABS(finalTM[1][1]) * *(float *)(iVar9 + 0x20);
    fVar5 = fVar2 - fVar4;
    fVar4 = fVar4 + fVar2;
    fVar6 = ABS((*finalTM)[2]) * *(float *)(iVar9 + 0x1c) +
            ABS(finalTM[1][2]) * *(float *)(iVar9 + 0x20) +
            ABS(finalTM[2][2]) * *(float *)(iVar9 + 0x24);
    fVar2 = fVar3 - fVar1;
    fVar7 = fVar8 - fVar6;
    fVar1 = fVar1 + fVar3;
    fVar8 = fVar8 + fVar6;
