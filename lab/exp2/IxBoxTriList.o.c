...

{
  ...
  int iStack_264;
  float fStack_260;
  McdModelID_conflict pMStack_25c;
  MeReal *apMStack_258 [3];
  ...
  fStack_260 = 9.18817e-41;
  boxgeom = (McdBoxID)McdModelGetGeometry();
  pMStack_25c = p->model2;
  fStack_260 = 9.19042e-41;
  trilistgeom = (McdTriangleListID)McdModelGetGeometry();
  pMStack_25c = p->model1;
  fStack_260 = 9.19252e-41;
  lVar33 = (longdouble)McdModelGetContactTolerance();
  eps = (MeReal)lVar33;
  pMStack_25c = p->model2;
  fStack_260 = 9.19476e-41;
  lVar33 = (longdouble)McdModelGetContactTolerance();
  eps = (MeReal)(lVar33 + (longdouble)eps);
  pMStack_25c = p->model1;
  fStack_260 = 9.1977e-41;
  pfVar26 = (float *)McdModelGetTransformPtr();
  pMStack_25c = p->model2;
  fStack_260 = 9.19938e-41;
  pfVar27 = (float *)McdModelGetTransformPtr();
  fwk = p->model1->frame;
  result->contactCount = 0;
  result->touch = 0;
  pMStack_25c = (McdModelID_conflict)boxgeom;
  fStack_260 = 9.20527e-41;
  boxRadii = (lsVec3 *)McdBoxGetRadii();
  apMStack_258[1] = &boxRadius;
  MStack_24c.frame = (McdFrameworkID)(pfVar27 + 0xc);
  diff.v[1] = pfVar26[0xd] - pfVar27[0xd];
  diff.v[2] = pfVar26[0xe] - pfVar27[0xe];
  diff.v[0] = pfVar26[0xc] - pfVar27[0xc];
  apMStack_258[0] = boxCentre;
  boxPosTrans.v[0] = diff.v[2] * pfVar27[2] + diff.v[0] * *pfVar27 + diff.v[1] * pfVar27[1];
  boxPosTrans.v[1] = diff.v[2] * pfVar27[6] + diff.v[0] * pfVar27[4] + diff.v[1] * pfVar27[5];
  boxPosTrans.v[2] = diff.v[2] * pfVar27[10] + diff.v[0] * pfVar27[8] + diff.v[1] * pfVar27[9];
  pMStack_25c = (McdModelID_conflict)boxgeom;
  fStack_260 = 9.22867e-41;
  McdBoxGetBSphere();
  pMVar23 = trilistgeom;
  MVar22 = eps;
  ...
  *(McdGeometryID *)((int)&pMStack_25c + iVar5) = pMVar3;
  *(float *)((int)&fStack_260 + iVar5) = MVar22 + boxRadius;
  *(lsVec3 **)((int)&iStack_264 + iVar5) = &boxPosTrans;
  *(McdGeometryID *)((int)&MStack_268 + iVar5) = pMVar23[3].prev;
  *(McdModelPair **)((int)aiStack_280 + iVar5 + 0x14) = p;
  pcVar4 = (code *)trilistgeom[3].mRefCtAndID;
  *(undefined4 *)((int)aiStack_280 + iVar5 + 0x10) = 0x1018e;
  count = (*pcVar4)();
  ...
  if (count != 0) {
    ...
    pMVar31 = result->contacts;
    fVar6 = pfVar26[2] * pfVar27[2] + pfVar26[1] * pfVar27[1] + *pfVar26 * *pfVar27;
    fVar7 = pfVar26[6] * pfVar27[2] + pfVar26[5] * pfVar27[1] + pfVar26[4] * *pfVar27;
    fVar8 = pfVar26[10] * pfVar27[2] + pfVar26[9] * pfVar27[1] + pfVar26[8] * *pfVar27;
    fVar9 = pfVar26[2] * pfVar27[6] + pfVar26[1] * pfVar27[5] + *pfVar26 * pfVar27[4];
    fVar10 = pfVar26[6] * pfVar27[6] + pfVar26[5] * pfVar27[5] + pfVar26[4] * pfVar27[4];
    fVar11 = pfVar26[10] * pfVar27[6] + pfVar26[9] * pfVar27[5] + pfVar26[8] * pfVar27[4];
    fVar12 = pfVar26[2] * pfVar27[10] + pfVar26[1] * pfVar27[9] + *pfVar26 * pfVar27[8];
    fVar13 = pfVar26[6] * pfVar27[10] + pfVar26[5] * pfVar27[9] + pfVar26[4] * pfVar27[8];
    fVar14 = pfVar26[10] * pfVar27[10] + pfVar26[9] * pfVar27[9] + pfVar26[8] * pfVar27[8];
    diff.v[0] = pfVar27[0xc] - pfVar26[0xc];
    diff.v[1] = (float)(MStack_24c.frame)->geometryRegisteredCount - pfVar26[0xd];
    diff.v[2] = (float)(MStack_24c.frame)->firstModel - pfVar26[0xe];
    fVar15 = diff.v[2] * pfVar26[2] + diff.v[1] * pfVar26[1] + diff.v[0] * *pfVar26;
    fVar17 = diff.v[2] * pfVar26[6] + diff.v[0] * pfVar26[4] + diff.v[1] * pfVar26[5];
    fVar16 = diff.v[0] * pfVar26[8] + diff.v[1] * pfVar26[9] + diff.v[2] * pfVar26[10];
    if (j < count) {
      MStack_24c.prev = (McdGeometryID)0x0;
      do {
        paMVar24 = ct.vertices[2];
        puVar32 = (undefined4 *)((int)&(trilistgeom[3].prev)->mRefCtAndID + (int)MStack_24c.prev);
        pfVar27 = (float *)*puVar32;
        (*ct.vertices[0])[0] = fVar12 * pfVar27[2] + fVar6 * *pfVar27 + fVar9 * pfVar27[1] + fVar15;
        (*ct.vertices[0])[1] = fVar13 * pfVar27[2] + fVar10 * pfVar27[1] + fVar7 * *pfVar27 + fVar17
        ;
        (*ct.vertices[0])[2] = fVar14 * pfVar27[2] + fVar11 * pfVar27[1] + fVar8 * *pfVar27 + fVar16
        ;
        pfVar27 = (float *)puVar32[1];
        (*ct.vertices[1])[0] = fVar12 * pfVar27[2] + fVar9 * pfVar27[1] + fVar6 * *pfVar27 + fVar15;
        (*ct.vertices[1])[1] = fVar13 * pfVar27[2] + fVar10 * pfVar27[1] + fVar7 * *pfVar27 + fVar17
        ;
        (*ct.vertices[1])[2] = fVar14 * pfVar27[2] + fVar11 * pfVar27[1] + fVar8 * *pfVar27 + fVar16
        ;
        pfVar27 = (float *)puVar32[2];
        (*ct.vertices[2])[0] = fVar12 * pfVar27[2] + fVar9 * pfVar27[1] + fVar6 * *pfVar27 + fVar15;
        (*ct.vertices[2])[1] = fVar13 * pfVar27[2] + fVar10 * pfVar27[1] + fVar7 * *pfVar27 + fVar17
        ;
        (*ct.vertices[2])[2] = fVar14 * pfVar27[2] + fVar11 * pfVar27[1] + fVar8 * *pfVar27 + fVar16
        ;
        pfVar27 = (float *)puVar32[3];
        (*ct.normal)[0] = fVar12 * pfVar27[2] + fVar9 * pfVar27[1] + fVar6 * *pfVar27;
        (*ct.normal)[1] = fVar13 * pfVar27[2] + fVar10 * pfVar27[1] + fVar7 * *pfVar27;
        (*ct.normal)[2] = fVar14 * pfVar27[2] + fVar11 * pfVar27[1] + fVar8 * *pfVar27;
        ct.flags = puVar32[5];
        ...
        *(MeVector3 **)((int)apMStack_258 + iVar5 + 8) = ct.vertices[2];
        verts = footprint;
        *(MeVector3 **)((int)apMStack_258 + iVar5 + 4) = paMVar24;
        edge[2][2] = fVar2 - fVar1;
        *(MeReal *)((int)apMStack_258 + iVar5) = fwk->mScale;
        *(MeReal (**) [3])((int)&pMStack_25c + iVar5) = edge;
        plVar30 = boxRadii;
        *(McdUserTriangle **)((int)&fStack_260 + iVar5) = &ct;
        MVar22 = eps;
        *(lsVec3 **)((int)&iStack_264 + iVar5) = plVar30;
        *(MeReal *)((int)&MStack_268 + iVar5) = MVar22;
        *(MeI16 **)((int)aiStack_280 + iVar5 + 0x14) = &dims;
        *(lsVec3 ***)((int)aiStack_280 + iVar5 + 0x10) = &verts;
        *(MeReal **)((int)aiStack_280 + iVar5 + 0xc) = &PN;
        *(lsVec3 **)((int)aiStack_280 + iVar5 + 8) = &normal;
        *(MeReal **)((int)aiStack_280 + iVar5 + 4) = &separation;
        *(undefined4 *)((int)aiStack_280 + iVar5) = 0x10622;
        bVar25 = McdVanillaOverlapOBBTri
                           (*(MeReal **)((int)aiStack_280 + iVar5 + 4),
                            *(lsVec3 **)((int)aiStack_280 + iVar5 + 8),
                            *(MeReal **)((int)aiStack_280 + iVar5 + 0xc),
                            *(lsVec3 ***)((int)aiStack_280 + iVar5 + 0x10),
                            *(MeI16 **)((int)aiStack_280 + iVar5 + 0x14),
                            *(MeReal *)((int)&MStack_268 + iVar5),
                            *(lsVec3 **)((int)&iStack_264 + iVar5),
                            *(McdUserTriangle **)((int)&fStack_260 + iVar5),
                            *(MeReal (**) [3])((int)&pMStack_25c + iVar5),
                            *(MeReal *)((int)apMStack_258 + iVar5));
        if (bVar25) {
                    /* Unresolved local var: lsVec3 * v@[DW_OP_reg1(ECX)] */
          plVar30 = footprint;
          diff.v[0] = normal.v[2] * pfVar26[8] + normal.v[1] * pfVar26[4] + normal.v[0] * *pfVar26;
          diff.v[1] = normal.v[2] * pfVar26[9] + normal.v[0] * pfVar26[1] + normal.v[1] * pfVar26[5]
          ;
          diff.v[2] = normal.v[2] * pfVar26[10] +
                      normal.v[0] * pfVar26[2] + normal.v[1] * pfVar26[6];
          if (plVar30 != verts) {
            iVar29 = result->contactCount;
            pMVar18 = pMVar31;
            do {
              pMVar31 = pMVar18;
              if (399 < iVar29) break;
              ...
              pMVar18->position[0] =
                   pfVar26[8] * plVar30->v[2] +
                   pfVar26[4] * plVar30->v[1] + *pfVar26 * plVar30->v[0] + pfVar26[0xc];
              pMVar18->position[1] =
                   pfVar26[9] * plVar30->v[2] +
                   pfVar26[5] * plVar30->v[1] + pfVar26[1] * plVar30->v[0] + pfVar26[0xd];
              pMVar19 = plVar30->v;
              pMVar20 = plVar30->v;
              pMVar21 = plVar30->v;
              plVar30 = plVar30 + 1;
              pMVar18->position[2] =
                   pfVar26[10] * pMVar21[2] + pfVar26[6] * pMVar20[1] + pfVar26[2] * *pMVar19 +
                   pfVar26[0xe];
              pMVar18->dims = dims;
              pMVar18->separation = separation;
              pMVar18->element2 = *(anon_union_4_2_43add64d_for_element2 *)(puVar32 + 4);
              pMVar18->normal[0] = diff.v[0];
              pMVar31 = pMVar18 + 1;
              pMVar18->normal[1] = diff.v[1];
              pMVar18->normal[2] = diff.v[2];
              iVar29 = result->contactCount + 1;
              result->contactCount = iVar29;
              pMVar18 = pMVar31;
            } while (plVar30 != verts);
          }
    ...
    if (result->contactCount < 1) {
      ...
      *(McdGeometryID *)((int)&pMStack_25c + iVar5) = MStack_24c.next;
      *(undefined4 *)((int)&fStack_260 + iVar5) = 0x107e1;
      MeVector3Normalize(*(MeReal **)((int)&pMStack_25c + iVar5));
      result->touch = 1;
    }
    MVar28 = result->touch;
  }
