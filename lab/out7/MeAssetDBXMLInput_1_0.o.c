  ...
  *(int *)((int)prim + 0xc) = iVar4;
  if (iVar2 <= iVar4) {
    *(int *)((int)prim + 0x14) = iVar2 * 2;
    uVar3 = (*_DAT_00013104)(*(undefined4 *)((int)prim + 0x10),iVar2 * 0x18,iVar4,iVar4);
    *(undefined4 *)((int)prim + 0x10) = uVar3;
  }
...

{
  ...
  for (iVar5 = 0x30; iVar5 != 0; iVar5 = iVar5 + -1) {
    pMVar7->name = *ppuVar6;
    ppuVar6 = ppuVar6 + 1;
    pMVar7 = (MeXMLHandler *)&pMVar7->type;
  }
  pvVar1 = (void *)(*_DAT_000130f4)(100);
  *(undefined4 *)((int)pvVar1 + 0xc) = 0;
  *(undefined4 *)((int)pvVar1 + 0x14) = 1;
  uVar2 = (*_MeMemoryAPI)(0xc);
  *(undefined4 *)((int)pvVar1 + 0x10) = uVar2;
  pvVar3 = PElementCreate(2,elem,pvVar1,FreePrimitive,elem->attr);
  PElementInsert(pvVar3,parent);
  MVar4 = MeXMLElementProcess(elem,handlers,pvVar1,pvVar3);
  return MVar4;
}
...

{
  ...
  pvVar1 = (void *)(*_DAT_000130f4)(0x44);
...

{
  ...
  pvVar1 = (void *)(*_DAT_000130f4)(0xbc);
...

{
  ...
  pvVar1 = (void *)(*_DAT_000130f4)(0x40);
...

{
  ...
  (*_DAT_000130fc)(*(undefined4 *)((int)m + 0x10));
  (*_DAT_000130fc)(m);
  return;
}
