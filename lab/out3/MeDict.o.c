...
MeDictNode * __regparm1 MeDictLookup(MeDict *dict,void *key)
...
MeDictNode * __regparm1 MeDictLowerBound(MeDict *dict,void *key)

{
  ...
  pMVar1 = (MeDictNode *)0x0;
  pMVar2 = *(MeDictNode **)key;
  while( true ) {
    while( true ) {
      if (pMVar2 == key) {
        return pMVar1;
                    ...
                    /* Unresolved local var: int result@[DW_OP_reg0(EAX)] */
      dict = (MeDict *)(**(code **)((int)key + 0x20))(in_stack_00000008,pMVar2->key,dict,dict);
      if ((int)dict < 1) break;
      pMVar2 = pMVar2->right;
    }
    if ((-1 < (int)dict) && (*(int *)((int)key + 0x30) == 0)) break;
    pMVar1 = pMVar2;
    pMVar2 = pMVar2->left;
  }
  return pMVar2;
...
MeDictNode * __regparm1 MeDictUpperBound(MeDict *dict,void *key)
    ...
    while( true ) {
      if (pMVar1 == key) {
        return pMVar2;
                    ...
                    /* Unresolved local var: int result@[DW_OP_reg0(EAX)] */
      dict = (MeDict *)(**(code **)((int)key + 0x20))(in_stack_00000008,pMVar1->key,dict,dict);
      if (-1 < (int)dict) break;
      pMVar1 = pMVar1->left;
    }
    if (((int)dict < 1) && (dict = *(MeDict **)((int)key + 0x30), dict == (MeDict *)0x0)) break;
    pMVar2 = pMVar1;
    pMVar1 = pMVar1->right;
  }
  return pMVar1;
...
void __regparm1 MeDictFreeNodes(MeDict *dict)

{
  MeDictNode *pMVar1;
  MeDict *dict_00;
  MeDictNode *in_stack_00000004;
  
                    /* Unresolved local var: MeDictNode * nil@[???]
                       Unresolved local var: MeDictNode * root@[DW_OP_reg6(ESI)] */
  pMVar1 = in_stack_00000004->left;
  if (pMVar1 != in_stack_00000004) {
    free_nodes(dict,in_stack_00000004,pMVar1->left);
    free_nodes(dict_00,in_stack_00000004,pMVar1->right);
    (*in_stack_00000004[1].key)(pMVar1,in_stack_00000004[1].data);
  }
  in_stack_00000004[1].left = (MeDictNode *)0x0;
  in_stack_00000004->left = in_stack_00000004;
  in_stack_00000004->right = in_stack_00000004;
  return;
}
...
void __regparm1 MeDictFree(MeDict *dict)

{
  ...
  if (pMVar1 != in_stack_00000004) {
    pMVar2 = pMVar1->left;
    if (pMVar2 != in_stack_00000004) {
      free_nodes(dict,in_stack_00000004,pMVar2->left);
      free_nodes((MeDict *)pMVar2->right,in_stack_00000004,pMVar2->right);
      dict = (MeDict *)(*in_stack_00000004[1].key)(pMVar2,in_stack_00000004[1].data);
    }
    pMVar2 = pMVar1->right;
    if (pMVar2 != in_stack_00000004) {
      free_nodes(dict,in_stack_00000004,pMVar2->left);
      free_nodes(dict_00,in_stack_00000004,pMVar2->right);
      dict = (MeDict *)(*in_stack_00000004[1].key)(pMVar2,in_stack_00000004[1].data);
    }
    (*in_stack_00000004[1].key)(pMVar1,in_stack_00000004[1].data,dict,dict);
  }
  in_stack_00000004[1].left = (MeDictNode *)0x0;
  in_stack_00000004->left = in_stack_00000004;
  in_stack_00000004->right = in_stack_00000004;
...
int __regparm1 MeDictContains(MeDict *dict,MeDictNode *node)

{
  MeDictNode *pMVar1;
  int iVar2;
  MeDictNode *in_stack_00000008;
  int local_14;
  ...
  if (pMVar1 == node) {
    ...
    local_14 = 0;
    if (((pMVar1 == in_stack_00000008) ||
        (iVar2 = verify_dict_has_node(&dict->nilnode,node,pMVar1->left), iVar2 != 0)) ||
       (iVar2 = verify_dict_has_node((MeDictNode *)0x0,node,pMVar1->right), iVar2 != 0)) {
      local_14 = 1;
    }
  }
  return local_14;
...
void __regparm1 free_nodes(MeDict *dict,MeDictNode *node,MeDictNode *nil)

{
  MeDictNode *in_stack_0000000c;
  
  if (nil != in_stack_0000000c) {
    free_nodes(dict,node,nil->left);
    free_nodes((MeDict *)nil->right,node,nil->right);
    (*node[1].key)(nil,node[1].data);
  }
  return;
}
...
int __regparm1 verify_dict_has_node(MeDictNode *nil,MeDictNode *root,MeDictNode *node)

{
  ...
  if (node == root) {
    ...
    local_14 = 0;
    if (((node == in_stack_0000000c) ||
        (iVar1 = verify_dict_has_node(nil,root,node->left), iVar1 != 0)) ||
       (iVar1 = verify_dict_has_node(node->right,root,node->right), iVar1 != 0)) {
      local_14 = 1;
    }
  }
  return local_14;
