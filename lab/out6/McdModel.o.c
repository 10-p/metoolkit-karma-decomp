...

{
  ...
  if ((cm->flags & 1U) != 0) {
    ...
    pvVar4 = McdGeometryInstanceGetTransformPtr(&cm->mInstance);
    (*_MeMatrix4TMCompound)(pvVar4);
  ...
  pMVar3 = cm->prev;
  pMVar3->next = pMVar2;
  (*_McdGeometryInstanceGetTransformPtr)(&pMVar5->modelPool,cm,pMVar3,pMVar3);
...

{
  ...
  if (relTM == (MeMatrix4Ptr)0x0) {
    ...
    compoundTM = (MeVector4 *)(*_McdGeometryInstanceGetBSphere)(0x40,0x10);
    relativeTM = (MeVector4 *)(*_McdGeometryInstanceGetBSphere)(0x40,0x10);
