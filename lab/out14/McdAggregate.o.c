...

{
  ...
  pMVar1 = (*_McdGeometryIncrementReferenceCount)(0x1c,0x10);
  pMVar4 = (McdAggregateID)0x0;
  if (pMVar1 != (McdAggregateID)0x0) {
    McdGeometryInit(pMVar1,frame,8);
    pvVar2 = (*_MeMemoryAPI)(maxChildren * 0x44);
    pMVar1[1].mRefCtAndID = (MeU32)pvVar2;
...
{
                    /* Unresolved local var: McdAggregate * a@[???] */
  McdGeometryDecrementReferenceCount(*(void **)(g[1].mRefCtAndID + 0x40 + element * 0x44));
...

{
  ...
  if (g != (McdGeometry *)0x0) {
    ...
    (*_McdGeometryDecrementReferenceCount)((void *)g[1].mRefCtAndID);
    McdGeometryDeinit(g);
    return;
  }
  return;
...

{
  ...
  p_Var11 = ins->child;
  i = 0;
  iVar10 = *(int *)((int)pvVar6 + 0x18);
  if (0 < iVar10) {
    local_b4 = 0;
    do {
      iVar8 = *(int *)((int)pvVar6 + 0x10);
      if (*(int *)(iVar8 + 0x40 + local_b4) != 0) {
        ...
        if (finalTM != (MeMatrix4Ptr)0x0) {
          ...
          iVar10 = 3;
          pfVar9 = (float *)(local_b4 + *(int *)((int)pvVar6 + 0x10));
...
/* ==== McdAggregateGetBSphere ==== */

void McdAggregateGetBSphere(McdGeometryID g,MeReal *center,MeReal *radius)
...
/* ==== McdAggregateMaximumPoint ==== */

void McdAggregateMaximumPoint(McdGeometryInstanceID ins,MeReal *inDir,MeReal *outPoint)
  ...
  if (0 < (int)pMVar9) {
    ...
    do {
      ...
      McdGeometryGetMassProperties
                (*(void **)(g[1].mRefCtAndID + 0x40 + local_164),subTM_1,subTM,&subVol_1);
      paMVar10 = totalSubTM;
...

{
  ...
  avgNormal[1] = 0.0;
  avgNormal[2] = 0.0;
  puVar15 = *(undefined4 **)((int)pvVar8 + 0x30);
  iVar12 = *(int *)((int)pvVar9 + 0x18);
  if (0 < iVar12) {
    local_3fd4 = 0;
    do {
      if (*(int *)(*(int *)((int)pvVar9 + 0x10) + 0x40 + local_3fd4) != 0) {
        ...
        if (iVar12 == 0) {
          ...
          if (dummyModel.mInstance.mTM == (MeMatrix4Ptr)0x0) {
                    /* Unresolved local var: MeReal * a@[DW_OP_reg0(EAX)]
                       ...
                       Unresolved local var: int j@[???] */
            paMVar11 = elementTM;
            pfVar5 = *(float **)((int)pvVar8 + 4);
            pfVar14 = (float *)(local_3fd4 + *(int *)((int)pvVar9 + 0x10));
            iVar12 = 3;
...

{
  ...
  float *pfVar11;
  undefined4 *puVar12;
  McdModelID_conflict pMVar13;
  undefined4 *puVar14;
  McdModel_conflict *pMVar15;
  ...
  for (iVar10 = 0x1e; iVar10 != 0; iVar10 = iVar10 + -1) {
    ...
    pMVar13 = (McdModelID_conflict)&pMVar13->prev;
    pMVar15 = (McdModel_conflict *)&pMVar15->prev;
  }
  i = 0;
  puVar12 = *(undefined4 **)((int)pvVar7 + 0x30);
  iVar10 = *(int *)((int)pvVar6 + 0x18);
  if (0 < iVar10) {
    local_10c = 0;
    do {
      if (*(int *)(*(int *)((int)pvVar6 + 0x10) + 0x40 + local_10c) != 0) {
        puVar14 = puVar12;
        ...
        if (dummyModel.mInstance.mTM == (MeMatrix4Ptr)0x0) {
          ...
          pfVar5 = *(float **)((int)pvVar7 + 4);
          iVar10 = 3;
          pfVar11 = (float *)(local_10c + *(int *)((int)pvVar6 + 0x10));
  ...
  if (((char)geom->mRefCtAndID == '\b') && (iVar8 = 0, 0 < (int)geom[1].prev)) {
    ...
    do {
      ...
      if (iVar8 < (int)geom[1].next) {
        local_60 = *(void **)(geom[1].mRefCtAndID + 0x40 + local_68);
      }
                    /* Unresolved local var: McdAggregate * a@[???] */
      pfVar6 = (float *)0x0;
      if (iVar8 < (int)geom[1].next) {
...
void McdAggregateRegisterInteractions(McdFrameworkID frame)
