...

{
  ...
  pMVar3 = (MeFPrimitiveNode *)(*_MeMemoryAPI)(0xc);
  pMVar3->current = p;
...

{
  ...
  pMVar1 = (MeFGeometry *)(*_MeMemoryAPI)(0x24);
  pMVar2 = (MeFPrimitiveNode *)(*_MeMemoryAPI)(0xc);
...

{
  ...
  geometry_00 = (MeFGeometry *)(*_MeFPrimitiveCreateCopy)(0x24);
  pMVar5 = (MeFPrimitiveNode *)(*_MeMemoryAPI)(0xc);
