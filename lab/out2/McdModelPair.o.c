...

{
  ...
  pMVar1 = (McdModelPairID)(*_MeMemoryAPI)(0x1c);
  pMVar1->model1 = m1;
  pMVar1->model2 = m2;
  pMVar2 = (McdRequest *)McdFrameworkGetDefaultRequestPtr(m1->frame);
...

{
  ...
  p->model1 = model1;
  p->model2 = model2;
  pMVar1 = (McdRequest *)McdFrameworkGetDefaultRequestPtr(model1->frame);
  p->userData = (void *)0x0;
  p->request = pMVar1;
