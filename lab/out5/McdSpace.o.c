...

{
  ...
  uVar1 = CxSmallSort::SetPairOverlapEnabled((int)cm1->mSpace,cm1->mSpaceID,SUB41(cm2->mSpaceID,0));
  return uVar1 & 0xff;
}
...

{
  ...
  uVar1 = CxSmallSort::SetPairOverlapEnabled((int)m1->mSpace,m1->mSpaceID,SUB41(m2->mSpaceID,0));
  return uVar1 & 0xff;
}
