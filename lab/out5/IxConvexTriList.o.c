...

{
  ...
  *(undefined4 *)((int)aiStackY_150 + iVar17) = 0x106a1;
  i = (*pcVar1)(*(void **)((int)aiStackY_150 + iVar17 + 4),
                *(void **)((int)aiStackY_150 + iVar17 + 8),*(void **)((int)aMStackY_144 + iVar17),
                *(float *)((int)aMStackY_144 + iVar17 + 4),*(int *)(&stack0xfffffec4 + iVar17));
  MVar24 = 0;
  if (i != 0) {
