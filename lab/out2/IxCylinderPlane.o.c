...

{
  ...
  lVar13 = (longdouble)McdCylinderGetRadius(uVar7);
  lVar14 = (longdouble)McdCylinderGetHalfHeight(uVar7);
  ...
  verts = plVar8;
  bVar4 = OverlapCylPlane(&separation,&verts,(float)(lVar12 + (longdouble)(float)lVar11),
                          (float)lVar13,(float)lVar14,&tBA);
  MVar9 = 0;
  if (bVar4) {
