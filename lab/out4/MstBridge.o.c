...
LAB_00010143:
  ...
  pMVar6 = (McdContact *)(*_MeMemoryAPI)(2000);
...

{
  ...
  pMVar1 = (McdContact *)(*_MeMemoryAPI)(s * 0x28);
  b->contacts = pMVar1;
  return;
}
