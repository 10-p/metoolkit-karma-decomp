...

{
  ...
  pMVar6 = &b->constraintDict;
  pvVar3 = MeDictFirst(pMVar6);
  while (pvVar3 != (void *)0x0) {
                    /* Unresolved local var: MdtBaseConstraint * cp@[DW_OP_reg6(ESI)] */
    pvVar1 = *(void **)((int)pvVar3 + 0x14);
    MeDictNext(pMVar6,pvVar3);
    pvVar3 = MeDictNext(pMVar6,pvVar3);
  ...
  pMVar2 = b->world;
  (b->keaBody).tag = -1;
  iVar5 = pMVar2->nBodies + -1;
  pMVar2->nBodies = iVar5;
  (*_MeDictInit)(&b->world->bodyPool,b,iVar5,iVar5);
  return;
}
