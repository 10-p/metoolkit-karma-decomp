...
void printMdtKeaBl2CBodyRowArray(int (*bl2cbody) [8],int numElts)

{
  ...
  if (numElts != 0) {
    do {
      ...
      iVar2 = iVar2 + 1;
      printf("% 3d ",(*paiVar1)[0],in_EAX,in_EAX);
      printf("% 3d ",(*paiVar1)[1]);
      printf("% 3d ",(*paiVar1)[2]);
      printf("% 3d ",(*paiVar1)[3]);
      printf("% 3d ",(*paiVar1)[4]);
...
void printMdtKeaBl2BodyRowArray(int (*bl2cbody) [8],int numElts)
