...

{
  ...
  if (pMVar1 != (McdSphylID)0x0) {
    McdGeometryInit(pMVar1,frame,5,extraout_ECX);
...

{
  ...
  fVar1 = ABS(*(float *)(iVar9 + 0x20)) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
  fVar3 = ABS(*(float *)(iVar9 + 0x24)) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
  fVar4 = ABS(*(float *)(iVar9 + 0x28)) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
  fVar2 = *(float *)(iVar9 + 0x30) - fVar1;
  ins->min[0] = fVar2;
  ins->min[1] = *(float *)(iVar9 + 0x34) - fVar3;
  ins->min[2] = *(float *)(iVar9 + 0x38) - fVar4;
  ins->max[0] = fVar1 + *(float *)(iVar9 + 0x30);
  ins->max[1] = fVar3 + *(float *)(iVar9 + 0x34);
  ins->max[2] = fVar4 + *(float *)(iVar9 + 0x38);
  if (finalTM != (MeMatrix4Ptr)0x0) {
    fVar1 = ABS(finalTM[2][0]) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
    fVar4 = ABS(finalTM[2][1]) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
    fVar6 = ABS(finalTM[2][2]) * *(float *)(iVar8 + 0x14) + *(float *)(iVar8 + 0x10);
...

{
  ...
  fVar4 = *(float *)(iVar10 + 0x30);
  fVar5 = *(float *)(iVar10 + 0x24);
  fVar6 = inDir[2];
  fVar7 = *(float *)(iVar10 + 0x28);
  *outPoint = fVar4;
  fVar8 = *(float *)(iVar10 + 0x34);
  ...
  if (fVar2 <= 0.0001) {
    if (fVar2 < -0.0001) {
      ...
      *outPoint = fVar1 * *(float *)(iVar10 + 0x20) + *outPoint;
      outPoint[1] = fVar1 * *(float *)(iVar10 + 0x24) + outPoint[1];
      outPoint[2] = fVar1 * *(float *)(iVar10 + 0x28) + outPoint[2];
    }
  }
  else {
    fVar2 = *(float *)(iVar9 + 0x14);
    *outPoint = fVar2 * *(float *)(iVar10 + 0x20) + fVar4;
    outPoint[1] = fVar2 * *(float *)(iVar10 + 0x24) + fVar8;
    outPoint[2] = fVar2 * *(float *)(iVar10 + 0x28) + fVar1;
  }
