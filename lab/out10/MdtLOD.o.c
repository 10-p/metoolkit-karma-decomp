...

{
  ...
  *(code **)((int)auStack_78 + iVar6 + 8) = CompareImportance;
  *(int *)((int)auStack_78 + iVar6 + 4) = iVar2 + 1;
  ...
  *(undefined4 *)((int)aiStack_90 + iVar6 + 0x10) = 0x1006d;
  MeHeapInit(*(void **)((int)aiStack_90 + iVar6 + 0x14),*(void **)((int)auStack_78 + iVar6),
             *(int *)((int)auStack_78 + iVar6 + 4),*(void **)((int)auStack_78 + iVar6 + 8));
  ppMVar18 = clist;
  ...
  if (0 < nCon) {
    ...
    if ((nCon & 1U) != 0) {
      ...
      *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x10138;
      ...
      pMVar3 = *ppMVar18;
      *(int *)((int)auStack_78 + iVar2 + iVar6 + 8) = iVar16;
      *(int *)((int)auStack_78 + iVar2 + iVar6 + 4) = iVar16;
      *(MdtPartitionParams **)((int)auStack_78 + iVar2 + iVar6) = params;
      ...
      *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x10163;
      MVar19 = ConstraintCalcImportance
                          ...
                          *(MdtPartitionParams **)((int)auStack_78 + iVar2 + iVar6));
      pMVar7 = group;
      (pMVar3->head).importance = MVar19;
      if ((group == (MdtContactGroupID_conflict)0x0) || (0 < (group->head).maxRows)) {
        *(MdtContactGroupID_conflict *)((int)auStack_78 + iVar2 + iVar6 + 8) = group;
        *(MdtContactGroupID_conflict *)((int)auStack_78 + iVar2 + iVar6 + 4) = pMVar7;
        *(MdtBaseConstraint **)((int)auStack_78 + iVar2 + iVar6) = *ppMVar18;
    ...
    do {
      ...
      *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x10274;
      ...
      if ((group == (MdtContactGroupID_conflict)0x0) || (0 < (group->head).maxRows)) {
        ...
        *(MdtBaseConstraint **)((int)auStack_78 + iVar2 + iVar6) = *(MdtBaseConstraint **)iVar16;
        *(MeHeap **)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = &q;
        ...
        if (iVar16 == -1) {
          ...
          *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6) = 0x109f5;
          ...
          if (MVar11 != 0) {
            ...
            *(MdtLODPartitionData **)((int)auStack_78 + iVar2 + iVar6 + 8) = pdataArray;
            *(MdtLODPartitionData **)((int)auStack_78 + iVar2 + iVar6 + 4) = pMVar8;
            *(int *)((int)auStack_78 + iVar2 + iVar6) = pMVar17->bodyCount * 4 + 4;
            *(MdtBody ***)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar17->bodyArray;
            *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x10a20;
            ppMVar12 = (*_DAT_00012030)(*(void **)((int)aiStack_90 + iVar2 + iVar6 + 0x14),
                                        *(uint *)((int)auStack_78 + iVar2 + iVar6));
        ...
        if (iVar16 == -1) {
          if (iVar15 == -1) {
            ...
            *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6) = 0x1092b;
            ...
            if (MVar11 != 0) {
                    /* Unresolved local var: MdtLODPartitionData * pData@[DW_OP_reg3(EBX)] */
              *(MeBool *)((int)auStack_78 + iVar2 + iVar6 + 8) = MVar11;
              pMVar17 = pMVar17 + iVar16;
              *(MeBool *)((int)auStack_78 + iVar2 + iVar6 + 4) = MVar11;
              *(int *)((int)auStack_78 + iVar2 + iVar6) = pMVar17->bodyCount * 4 + 4;
              *(MdtBody ***)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar17->bodyArray;
              ...
              *(int *)((int)auStack_78 + iVar2 + iVar6) = iVar15 * 4 + 4;
              *(MdtBody ***)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar17->bodyArray;
            ...
            *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6) = 0x1089b;
            ...
            if (MVar11 != 0) {
              ...
              *(int *)((int)auStack_78 + iVar2 + iVar6 + 8) = iVar15 * 5;
              *(int *)((int)auStack_78 + iVar2 + iVar6 + 4) = iVar15 * 5;
              *(int *)((int)auStack_78 + iVar2 + iVar6) = pMVar17->bodyCount * 4 + 4;
              *(MdtBody ***)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar17->bodyArray;
          ...
          *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6) = 0x10825;
          ...
          if (MVar11 != 0) {
                    /* Unresolved local var: MdtLODPartitionData * pData@[DW_OP_reg3(EBX)] */
            *(MdtBaseConstraint **)((int)auStack_78 + iVar2 + iVar6 + 8) = pMVar3;
            *(MdtBaseConstraint **)((int)auStack_78 + iVar2 + iVar6 + 4) = pMVar3;
            pMVar17 = pMVar17 + iVar16;
            *(int *)((int)auStack_78 + iVar2 + iVar6) = pMVar17->bodyCount * 4 + 4;
            *(MdtBody ***)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar17->bodyArray;
...
LAB_00010865:
          ...
          *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x1033b;
          ...
          if ((iVar4 + iVar16 + 1 < params->maxMatrixSize) || (pvVar10 == (void *)0x0)) {
            *(void **)((int)auStack_78 + iVar2 + iVar6 + 8) = pvVar10;
            *(int *)((int)auStack_78 + iVar2 + iVar6 + 4) = iVar15;
            *(int *)((int)auStack_78 + iVar2 + iVar6) = b0PIx;
            ...
            *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x107db;
            MergePartitions(*(MdtLODPartitionData **)((int)aiStack_90 + iVar2 + iVar6 + 0x14),
                            *(int *)((int)auStack_78 + iVar2 + iVar6),
                            *(int *)((int)auStack_78 + iVar2 + iVar6 + 4));
            *(MeHeap **)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = &q;
            goto LAB_000107de;
          }
        }
        ...
        *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x10421;
        ...
        if (0 < *(int *)((int)&pdataArray->conCount + local_6c.bodyCount)) {
          ...
          do {
            ...
            *(int *)((int)auStack_78 + iVar2 + iVar6 + 8) = iVar15;
            iVar16 = iVar16 + 1;
            *(int *)((int)auStack_78 + iVar2 + iVar6 + 4) = iVar15;
            *(MdtPartitionParams **)((int)auStack_78 + iVar2 + iVar6) = params;
            *(MdtBaseConstraint **)((int)aiStack_90 + iVar2 + iVar6 + 0x14) = pMVar3;
            ...
            *(MdtBaseConstraint **)((int)auStack_78 + iVar2 + iVar6) = pMVar3;
          ...
          if (uVar13 < 2) {
            if (pdataArray->bodyArray != (MdtBody **)0x0) {
              ...
              *(undefined4 *)((int)aiStack_90 + iVar2 + iVar6 + 0x10) = 0x107a7;
              (*_qsort)(*(void **)((int)aiStack_90 + iVar2 + iVar6 + 0x14));
            }
...

{
  ...
  ppMVar4 = (*_DAT_00012030)(pMVar1->bodyArray,(pMVar2->bodyCount + pMVar1->bodyCount) * 4);
  pMVar1->bodyArray = ppMVar4;
  iVar6 = 0;
  ppMVar5 = (*_DAT_00012030)(pMVar1->conArray,(iVar3 + iVar7) * 4);
...

{
  ...
  if ((con->head).LODpartIndex == -1) {
                    /* Unresolved local var: MdtLODPartitionData * pData@[DW_OP_reg3(EBX)] */
    ppMVar4 = (*_DAT_00012030)(pdataArray[LODpartIx].conArray,pdataArray[LODpartIx].conCount * 4 + 4
                              );
