...

{
  ...
  ppMVar3 = (*_MeMemoryAPI)(pMVar1->bucketCount << 2);
  iVar2 = 0;
...

{
  ...
  pMVar1 = (*_MeMemoryAPI)(0x38);
  pMVar2 = (*_MeMemoryAPI)(0x1c);
...
LAB_00010454:
  if (pMVar5 == (McdModelPairManagerLink *)0x0) {
    pMVar5 = (*_DAT_00011010)(manager->linkPool);
    if (pMVar5 == (McdModelPairManagerLink *)0x0) {
      (*manager->poolFullHandler)(m1,m2);
    }
    else {
      pMVar5->key = uVar8;
      pMVar6 = (*_DAT_00011010)(manager->pairPool);
      pMVar5->pair = pMVar6;
...
LAB_000105a2:
  if (pMVar9 != (McdModelPairManagerLink *)0x0) {
    ...
    if (MVar4 == kMcdFFStateHello) {
      ...
      (*_DAT_00011014)(manager->pairPool,pMVar9->pair);
      (*_DAT_00011014)(manager->linkPool,pMVar9);
    }
    else {
...

{
  ...
  do {
    ...
    (*_DAT_00011014)(manager->pairPool,pMVar7->pair);
