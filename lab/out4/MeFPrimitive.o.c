...

{
  ...
  pMVar1 = (MeFPrimitive *)(*_DAT_0001100c)(100);
  pMVar1->id = (char *)0x0;
  pMVar1->geometry = (MeFGeometry *)0x0;
  pMVar1->nVertices = 0;
  pMVar1->maxVertices = 1;
  paMVar2 = (MeVector3 *)(*_MeMemoryAPI)(0xc);
...

{
  ...
  pMVar2 = (MeFPrimitive *)(*_DAT_0001100c)(100);
  ...
  pMVar3 = (MeReal *)(*_MeMemoryAPI)(p->maxVertices * 0xc);
...

{
  ...
  if (iVar1 <= p->nVertices) {
    ...
    paMVar2 = (MeVector3 *)(*_DAT_0001101c)(p->vertices,iVar1 * 0x18,paMVar2,paMVar2);
    p->vertices = paMVar2;
  }
  return;
}
...

{
  ...
  pMVar1 = (MeReal *)(*_DAT_0001101c)(p->vertices,nVertices * 0xc);
