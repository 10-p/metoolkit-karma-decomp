...

{
  ...
  *(undefined4 *)((int)aiStackY_280 + iVar5 + 0x10) = 0x1018e;
  count = (*pcVar4)(*(void **)((int)aiStackY_280 + iVar5 + 0x14),
                    *(void **)((int)&MStackY_268 + iVar5),*(void **)((int)&iStackY_264 + iVar5),
                    *(float *)((int)&fStackY_260 + iVar5),*(int *)(&stack0xfffffda4 + iVar5));
