...

{
  ...
  lVar14 = (longdouble)McdCylinderGetRadius(uVar6);
  lVar15 = (longdouble)McdCylinderGetHalfHeight(uVar6);
  lVar16 = (longdouble)McdCylinderGetRadius(uVar7);
  lVar17 = (longdouble)McdCylinderGetHalfHeight(uVar7);
  iVar8 = 0x2f;
  ...
  plVar11 = footprint;
  verts = plVar11;
  bVar3 = OverlapCylCyl(&separation,&normal,&PN,&verts,&dims,
                        (float)(lVar13 + (longdouble)(float)lVar12),(float)lVar14,(float)lVar15,
                        (float)lVar16,(float)lVar17,&tAB,pMVar1->mScale);
  uVar10 = 0;
  if (bVar3) {
...

{
  ...
  plVar2 = (lsVec3 *)McdModelGetLinearVelocityPtr(p->model1);
  plVar3 = (lsVec3 *)McdModelGetLinearVelocityPtr(p->model2);
  lVar7 = (longdouble)McdCylinderGetRadius(uVar1);
  lVar8 = (longdouble)McdCylinderGetHalfHeight(uVar1);
  lVar9 = (longdouble)McdCylinderGetRadius(uVar1);
  lVar10 = (longdouble)McdCylinderGetHalfHeight(uVar1);
                    /* Unresolved local var: float __result@[DW_OP_reg13(ST2)] */
  plVar4 = (lsTransform *)McdModelGetTransformPtr(p->model1);
  plVar5 = (lsTransform *)McdModelGetTransformPtr(p->model2);
  ext2[0] = (float)lVar9 * 0.8284271;
  ext2[1] = (float)lVar9 * 0.8284271;
  ext2[2] = (float)lVar10;
  ext1[0] = (float)lVar7 * 0.8284271;
  ext1[1] = (float)lVar7 * 0.8284271;
  ext1[2] = (float)lVar8;
  iVar6 = MovingBoxBoxIntersect(ext1,plVar4,plVar2,ext2,plVar5,plVar3,maxTime,&T,&P);
  if (iVar6 == 0) {
    result->time = maxTime;
  }
  else {
