...

{
  ...
  _poolstack_ptr = 0;
  _pool_ptr = size;
  _pool_max = size + in_stack_0000000c;
  return;
}
...

{
  ...
  if (_pool_max < (undefined1 *)((int)_pool_ptr->invI0 + iVar10)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  pMVar1 = (MdtKeaVelocity *)((int)_pool_ptr->invI0 + iVar10);
  mem->invIworld = _pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)pMVar1;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  ...
  if (_pool_max < (undefined1 *)((int)((MdtKeaVelocity *)_pool_ptr)->velocity + iVar10)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  paMVar2 = (MdtKeaJBlockPair *)((int)((MdtKeaVelocity *)_pool_ptr)->velocity + iVar10);
  mem->vhmf = (MdtKeaVelocity *)_pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)paMVar2;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  if (_pool_max <
      (*(MdtKeaJBlockPair *)((int)_pool_ptr + total_strips_exc_padding * 5 * 0xc0))[0].col + 4) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  paMVar3 = (*(MdtKeaJBlockPair *)((int)_pool_ptr + total_strips_exc_padding * 5 * 0xc0))[0].col + 4
  ;
  mem->jm = (MdtKeaJBlockPair *)_pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)paMVar3;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  ...
  if (_pool_max < (undefined1 *)((int)_pool_ptr->invI0[0] + iVar10)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  piVar4 = (int *)((int)_pool_ptr->invI0[0] + iVar10);
  mem->rhs = _pool_ptr->invI0;
  _pool_ptr = (MdtKeaInverseMassMatrix *)piVar4;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  ...
  if (_pool_max < (undefined1 *)(uVar9 + (int)_pool_ptr)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  piVar4 = (int *)((int)_pool_ptr + uVar9);
  ...
  paiVar5 = (MdtKeaBl2CBodyRow *)((int)_pool_ptr + uVar9);
  mem->jlen = (int *)_pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)paiVar5;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  ...
  if (_pool_max < (undefined1 *)((int)*(MdtKeaBl2CBodyRow *)_pool_ptr + iVar10)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  paiVar6 = (MdtKeaBl2BodyRow *)((int)*(MdtKeaBl2CBodyRow *)_pool_ptr + iVar10);
  mem->bl2cbody = (MdtKeaBl2CBodyRow *)_pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)paiVar6;
                    /* Unresolved local var: void * addr@[DW_OP_reg0(EAX)] */
  ...
  if (_pool_max < (undefined1 *)((int)*(MdtKeaBl2BodyRow *)_pool_ptr + iVar10)) {
    MeFatalError(3,
                 "Kea error:Memory pool size exceeded when allocating %s of size %d\nPool ends at %08x\nIf memory were allocated, pool would end at %08x"
                );
  }
  paiVar6 = (MdtKeaBl2BodyRow *)((int)*(MdtKeaBl2BodyRow *)_pool_ptr + iVar10);
  ...
  iVar10 = (int)*(MdtKeaBl2BodyRow *)_pool_ptr + iVar10;
  mem->bl2body = (MdtKeaBl2BodyRow *)_pool_ptr;
  _pool_ptr = (MdtKeaInverseMassMatrix *)iVar10;
  return;
}
...
void keaFunctions_Vanilla::allocateMemory
               (keaTempMemory *mem,MdtKeaConstraints constraints,int num_bodies)

{
  ...
  ppiVar2 = (int **)&constraints.max_partitions;
  ...
  vanillaAllocateMemory
            ((keaTempMemory *)constraints.num_partitions,in_stack_ffffff88,in_stack_00000068);
  return;
}
