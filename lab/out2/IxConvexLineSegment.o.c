...

{
  ...
  uVar13 = McdModelGetGeometry(model);
  pfVar14 = (float *)McdModelGetTransformPtr(model);
  ...
  iVar18 = 0;
  iVar15 = McdConvexMeshGetPolyhedron(uVar13);
  tnear = -1e+20;
  fVar6 = fVar5;
  if (0 < *(int *)(iVar15 + 0x14)) {
    do {
      ...
      pfVar17 = (float *)(iVar18 * 0x10 + *(int *)(iVar15 + 4));
      pfVar16 = (float *)McdCnvFaceGetVertexPosition(iVar15,iVar18,0,*(int *)(iVar15 + 4));
      fVar4 = *pfVar17;
      fVar7 = pfVar17[1];
      fVar8 = pfVar17[2];
      fVar9 = fVar8 * dir.v[2] + fVar4 * dir.v[0] + fVar7 * dir.v[1];
      fVar4 = (fVar4 * fVar3 + fVar7 * fVar2 + fVar8 * fVar1) -
              (fVar4 * *pfVar16 + fVar7 * pfVar16[1] + fVar8 * pfVar16[2]);
      if (fVar6 < tnear) {
        return 0;
      }
      if (1e-06 <= ABS(fVar9)) {
  ...
  if (tnear < 0.0) {
    ...
    pfVar16 = (float *)(bnorm_num * 0x10 + *(int *)(iVar15 + 4));
  }
  else {
    pfVar16 = (float *)(fnorm_num * 0x10 + *(int *)(iVar15 + 4));
    fVar6 = tnear;
  }
  fVar5 = fVar6 / fVar5;
  fVar1 = inOrig[1];
  ...
  fVar11 = pfVar14[10];
  fVar12 = pfVar16[2];
  info->normal[0] = pfVar14[8] * pfVar16[2] + pfVar14[4] * pfVar16[1] + *pfVar14 * *pfVar16;
...
{
  McdFrameworkSetLineSegInteraction(frame,7,0x10000);
  return;
}
