...

{
  ...
  pMVar3 = (*_MeMemoryAPI)((geoTypeMaxCount + 9) * 0x28);
  ...
  pMVar4 = (*_MeMemoryAPI)(pMVar1->geometryRegisteredCountMax * pMVar1->geometryRegisteredCountMax *
                           0x1c);
