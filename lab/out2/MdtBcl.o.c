...

{
  ...
  pfVar17 = clist->c + iVar4;
  pMVar15 = clist->xi + iVar4;
  pMVar19 = clist->lo + iVar4;
  pMVar12 = clist->hi + iVar4;
  pfVar18 = clist->slipfactor + iVar4;
  pMVar16 = clist->xgamma + iVar4;
  uVar5 = *(uint *)((int)constraint + 0x1a0);
  ...
  bVar11 = false;
  if ((*(int *)((int)constraint + 0xb8) == -1) && ((uVar5 & 0x100) != 0)) {
    bVar11 = true;
  }
  uVar6 = *(undefined4 *)((int)constraint + 0x54);
  iVar4 = *(int *)((int)constraint + 0x58);
  boxScale = 1.0;
  MdtBodyGetCenterOfMassPosition(uVar6,pos0,pMVar12,pMVar12);
  pos0[0] = *(float *)((int)constraint + 0x160) - pos0[0];
  pos0[1] = *(float *)((int)constraint + 0x164) - pos0[1];
  pos0[2] = *(float *)((int)constraint + 0x168) - pos0[2];
  MdtBodyGetVelocityAtPoint(uVar6,(int)constraint + 0x160,vel0);
  if (iVar4 == 0) {
    if ((uVar5 & 0x100) == 0) {
      vel1[2] = 0.0;
      vel1[1] = 0.0;
    ...
    MdtBodyGetCenterOfMassPosition(iVar4,pos1,extraout_ECX,extraout_ECX);
    pos1[0] = *(float *)((int)constraint + 0x160) - pos1[0];
    pos1[1] = *(float *)((int)constraint + 0x164) - pos1[1];
    pos1[2] = *(float *)((int)constraint + 0x168) - pos1[2];
    MdtBodyGetVelocityAtPoint(iVar4,(int)constraint + 0x160,vel1);
  }
  fVar8 = vel0[0] - vel1[0];
  ...
  *pfVar17 = 0.0;
  *pMVar16 = 0.0;
  MdtContactWriteRow(clist,0,(MeReal *)((int)constraint + 0x16c),pos0,pos1,(uint)(iVar4 != 0));
  ...
  *pMVar12 = 3.4028235e+38;
  ...
  if (((uVar5 & 2) != 0) && (fVar1 < -*(float *)((int)constraint + 0x1a8))) {
  ...
  if (friction_rows != 0) {
    ...
    if (friction_rows != 0) {
      ...
      pfVar17[1] = 0.0;
      pMVar16[1] = 0.0;
      MdtContactWriteRow(clist,1,dir1,pos0,pos1,(uint)(iVar4 != 0));
      if (((uVar5 & 0x10) != 0) &&
  ...
  if (friction_rows == 2) {
    ...
    pfVar17[2] = 0.0;
    pMVar16[2] = 0.0;
    MdtContactWriteRow(clist,2,dir2,pos0,pos1,(uint)(iVar4 != 0));
    if (((uVar5 & 0x20) != 0) &&
...

{
  ...
  *pMVar21 = 0.0;
  ...
  clist->Jbody[clist->num_constraints][1] = iVar19;
  MeQuaternionFromTM(qaca,(int)constraint + 0xbc,iVar19,iVar19);
  ...
  if (*(int *)((int)constraint + 0xb8) == -1) {
    ...
    MeQuaternionFromTM(qbcw,Rbcw,extraout_EDX,extraout_EDX);
    iVar19 = *(int *)((int)constraint + 0xb8);
  }
  else {
    MeQuaternionFromTM(qbcb,(int)constraint + 0xfc,pMVar23,pMVar23);
...

{
  ...
  pMVar18 = clist->c + iVar16;
  pfVar20 = clist->xi + iVar16;
  pMVar14 = clist->lo + iVar16;
  pMVar19 = clist->hi + iVar16;
  pfVar17 = clist->slipfactor + iVar16;
  pfVar21 = clist->xgamma + iVar16;
                    /* Unresolved local var: int z@[DW_OP_reg7(EDI)] */
  iVar16 = 0;
  do {
    iVar2 = clist->num_rows_inc_padding;
    ...
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10) = 0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2;
    if (iVar2 < 0) {
      iVar15 = iVar2 + 3;
    }
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 0x60) =
         0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2;
    if (iVar2 < 0) {
    ...
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10 + 0x10) =
         0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2;
    if (iVar2 < 0) {
    ...
    iVar22 = iVar16 + 2;
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 0x70) =
         0;
    iVar16 = iVar22;
  } while (iVar22 != 6);
  *pfVar20 = 0.0;
  ...
  *pfVar21 = 0.0;
  ...
  do {
    ...
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + 4 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10) = 0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2 + 1;
    if (iVar15 < 0) {
      iVar15 = iVar2 + 4;
    }
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 100) =
         0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2 + 1;
    if (iVar15 < 0) {
    ...
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10 + 0x14) =
         0;
    iVar2 = clist->num_rows_inc_padding;
    iVar15 = iVar2 + 1;
    if (iVar15 < 0) {
    ...
    iVar22 = iVar16 + 2;
    *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 0x74) =
         0;
    iVar16 = iVar22;
  } while (iVar22 != 6);
  pfVar20[1] = 0.0;
  ...
  clist->Jbody[clist->num_constraints][0] = *(int *)((int)constraint + 0xb4);
  paiVar3 = clist->Jbody;
  paiVar3[clist->num_constraints][1] = *(int *)((int)constraint + 0xb8);
  MeQuaternionFromTM(qaca,(int)constraint + 0xbc,paiVar3,paiVar3);
  iVar16 = *(int *)((int)constraint + 0x54);
  qacw[0] = ((qaca[0] * *(float *)(iVar16 + 0xb0) - qaca[1] * *(float *)(iVar16 + 0xb4)) -
            qaca[2] * *(float *)(iVar16 + 0xb8)) - qaca[3] * *(float *)(iVar16 + 0xbc);
  qacw[1] = (*(float *)(iVar16 + 0xb8) * qaca[3] +
            qaca[1] * *(float *)(iVar16 + 0xb0) + qaca[0] * *(float *)(iVar16 + 0xb4)) -
            *(float *)(iVar16 + 0xbc) * qaca[2];
  qacw[2] = (*(float *)(iVar16 + 0xbc) * qaca[1] +
            qaca[0] * *(float *)(iVar16 + 0xb8) + qaca[2] * *(float *)(iVar16 + 0xb0)) -
            *(float *)(iVar16 + 0xb4) * qaca[3];
  qacw[3] = (qaca[0] * *(float *)(iVar16 + 0xbc) + qaca[3] * *(float *)(iVar16 + 0xb0) +
            qaca[2] * *(float *)(iVar16 + 0xb4)) - qaca[1] * *(float *)(iVar16 + 0xb8);
  if (*(int *)((int)constraint + 0xb8) == -1) {
    MeQuaternionFromTM(qbcw,(int)constraint + 0xfc,constraint,constraint);
    Rbcw[0][0] = *(MeReal *)((int)constraint + 0xfc);
    Rbcw[0][1] = *(MeReal *)((int)constraint + 0x100);
    Rbcw[0][2] = *(MeReal *)((int)constraint + 0x104);
    Rbcw[1][0] = *(MeReal *)((int)constraint + 0x10c);
    ...
    MeQuaternionFromTM(qbcb,(int)constraint + 0xfc,iVar16,iVar16);
    iVar16 = *(int *)((int)constraint + 0x58);
    qbcw[0] = ((qbcb[0] * *(float *)(iVar16 + 0xb0) - qbcb[1] * *(float *)(iVar16 + 0xb4)) -
              qbcb[2] * *(float *)(iVar16 + 0xb8)) - qbcb[3] * *(float *)(iVar16 + 0xbc);
    qbcw[1] = (*(float *)(iVar16 + 0xb8) * qbcb[3] +
              qbcb[0] * *(float *)(iVar16 + 0xb4) + qbcb[1] * *(float *)(iVar16 + 0xb0)) -
              qbcb[2] * *(float *)(iVar16 + 0xbc);
    qbcw[2] = (qbcb[1] * *(float *)(iVar16 + 0xbc) +
              qbcb[0] * *(float *)(iVar16 + 0xb8) + qbcb[2] * *(float *)(iVar16 + 0xb0)) -
              *(float *)(iVar16 + 0xb4) * qbcb[3];
                    /* Unresolved local var: MeReal q0t2@[DW_OP_reg14(ST3)]
                       Unresolved local var: MeReal q1t2@[DW_OP_reg16(ST5)]
                       Unresolved local var: MeReal q0q3@[DW_OP_reg14(ST3)]
                       Unresolved local var: MeReal q1q2@[DW_OP_reg15(ST4)]
                       Unresolved local var: MeReal q1q3@[DW_OP_reg16(ST5)]
                       Unresolved local var: MeReal q2q3@[DW_OP_reg12(ST1)] */
    qbcw[3] = (qbcb[0] * *(float *)(iVar16 + 0xbc) + qbcb[3] * *(float *)(iVar16 + 0xb0) +
              qbcb[2] * *(float *)(iVar16 + 0xb4)) - qbcb[1] * *(float *)(iVar16 + 0xb8);
    fVar8 = qbcw[0] + qbcw[0];
    fVar4 = qbcw[3] * qbcw[3];
    fVar7 = qbcw[2] * qbcw[2];
    Rbcw[0][0] = ((qbcw[0] * qbcw[0] + qbcw[1] * qbcw[1]) - fVar7) - fVar4;
    fVar1 = (qbcw[1] + qbcw[1]) * qbcw[2];
    fVar5 = (qbcw[1] + qbcw[1]) * qbcw[3];
    Rbcw[1][0] = fVar1 - fVar8 * qbcw[3];
    fVar9 = qbcw[0] * qbcw[0] - qbcw[1] * qbcw[1];
    fVar6 = (qbcw[2] + qbcw[2]) * qbcw[3];
    Rbcw[2][0] = fVar8 * qbcw[2] + fVar5;
    Rbcw[0][1] = fVar1 + fVar8 * qbcw[3];
    Rbcw[0][2] = fVar5 - fVar8 * qbcw[2];
    Rbcw[1][1] = (fVar9 + fVar7) - fVar4;
    Rbcw[2][2] = (fVar9 - fVar7) + fVar4;
    Rbcw[2][1] = fVar6 - qbcw[1] * fVar8;
    Rbcw[1][2] = fVar6 + qbcw[1] * fVar8;
  }
                    /* Unresolved local var: MeReal q0sq@[DW_OP_reg16(ST5)]
                       Unresolved local var: MeReal q0t2@[DW_OP_reg12(ST1)]
                       Unresolved local var: MeReal q1t2@[DW_OP_reg15(ST4)]
  ...
  fVar6 = ((qacw[1] * qacw[1] + qacw[0] * qacw[0]) - qacw[2] * qacw[2]) - qacw[3] * qacw[3];
  fVar5 = (qacw[0] + qacw[0]) * qacw[3] + (qacw[1] + qacw[1]) * qacw[2];
  fVar4 = (qacw[1] + qacw[1]) * qacw[3] - (qacw[0] + qacw[0]) * qacw[2];
  uVar24 = 0;
  do {
    fVar1 = qacw[uVar24];
    iVar16 = uVar24 + 1;
    ...
    qmul[uVar24][2] = fVar1 * qbcw[2];
    fVar1 = qacw[iVar16];
    qmul[iVar16][0] = qbcw[0] * fVar1;
    qmul[iVar16][1] = qbcw[1] * fVar1;
    qmul[iVar16][2] = qbcw[2] * fVar1;
    qmul[iVar16][3] = fVar1 * qbcw[3];
    uVar24 = uVar23;
  } while (uVar23 < 4);
  fVar1 = ((qmul[0][1] - qmul[1][0]) + qmul[3][2]) - qmul[2][3];
                    /* Unresolved local var: MeReal q0sq@[DW_OP_reg16(ST5)]
                       ...
                       Unresolved local var: MeReal q1q3@[DW_OP_reg15(ST4)]
                       Unresolved local var: MeReal q2q3@[DW_OP_reg13(ST2)] */
  fVar9 = ((qmul[2][1] - qmul[3][0]) - qmul[1][2]) + qmul[0][3];
  fVar12 = qmul[1][1] + qmul[0][0] + qmul[2][2] + qmul[3][3];
  fVar8 = (-qmul[2][0] - qmul[3][1]) + qmul[0][2] + qmul[1][3];
  fVar7 = (fVar1 + fVar1) * fVar8 - (fVar12 + fVar12) * fVar9;
  fVar10 = ((fVar1 * fVar1 + fVar12 * fVar12) - fVar8 * fVar8) - fVar9 * fVar9;
  fVar8 = (fVar12 + fVar12) * fVar8 + (fVar1 + fVar1) * fVar9;
  fVar9 = fVar10 + 1.0;
  fVar12 = fVar9 + fVar9;
  if (1e-06 < fVar12) {
                    /* Unresolved local var: MeReal Sqrt2_r00p1@[???]
                       Unresolved local var: float __result@[DW_OP_reg11(ST0)] */
    fVar13 = SQRT(fVar12);
    fVar11 = 1.0 / (fVar9 + fVar13);
    fVar9 = (1.0 / (fVar9 * (fVar12 + fVar12 + (fVar10 + 3.0) * fVar13))) * (fVar13 + 1.0);
    *pfVar20 = fVar7 * fVar11;
    pfVar20[1] = fVar11 * fVar8;
    fVar13 = fVar5 * Rbcw[0][2] - fVar4 * Rbcw[0][1];
    fVar12 = Rbcw[0][1] * fVar6 - Rbcw[0][0] * fVar5;
    fVar10 = fVar4 * Rbcw[0][0] - Rbcw[0][2] * fVar6;
    fVar7 = fVar9 * fVar7;
    t1[0] = (fVar5 * Rbcw[1][2] - fVar4 * Rbcw[1][1]) * fVar11 - fVar13 * fVar7;
    fVar9 = fVar9 * fVar8;
    t1[1] = (fVar4 * Rbcw[1][0] - Rbcw[1][2] * fVar6) * fVar11 - fVar10 * fVar7;
    t1[2] = (Rbcw[1][1] * fVar6 - Rbcw[1][0] * fVar5) * fVar11 - fVar7 * fVar12;
    t2[0] = (fVar5 * Rbcw[2][2] - fVar4 * Rbcw[2][1]) * fVar11 - fVar13 * fVar9;
    t2[1] = (fVar4 * Rbcw[2][0] - Rbcw[2][2] * fVar6) * fVar11 - fVar10 * fVar9;
    t2[2] = (fVar6 * Rbcw[2][1] - Rbcw[2][0] * fVar5) * fVar11 - fVar9 * fVar12;
    iVar15 = clist->num_rows_inc_padding;
    iVar16 = iVar15;
    if (iVar15 < 0) {
      iVar16 = iVar15 + 3;
    }
    *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x30) = t1[0];
    iVar15 = clist->num_rows_inc_padding;
    iVar16 = iVar15 + 1;
    if (iVar16 < 0) {
      iVar16 = iVar15 + 4;
    }
    *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x34) = t2[0];
    uVar24 = 1;
    do {
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15;
      ...
      *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + uVar24 * 0x10 + 0x30) =
           t1[uVar24];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 1;
      if (iVar16 < 0) {
      ...
      *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + uVar24 * 0x10 + 0x34) =
           t2[uVar24];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15;
      if (iVar15 < 0) {
      ...
      *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + uVar24 * 0x10 + 0x40) =
           t1[uVar24 + 1];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 1;
      if (iVar16 < 0) {
      ...
      uVar23 = uVar24 + 2;
      *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + uVar24 * 0x10 + 0x44) =
           t2[uVar24 + 1];
      uVar24 = uVar23;
    } while (uVar23 < 3);
    if (*(int *)((int)constraint + 0xb8) != -1) {
      ...
      *(float *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x90) = -t1[0];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 1;
      if (iVar16 < 0) {
        iVar16 = iVar15 + 4;
      }
      *(float *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x94) = -t2[0];
      uVar24 = 1;
      do {
        iVar15 = clist->num_rows_inc_padding;
        iVar16 = iVar15;
        ...
        *(float *)((int)*clist->Jstore + iVar15 * 4 + uVar24 * 0x10 + (iVar16 >> 2) * 0xb0 + 0x90) =
             -t1[uVar24];
        iVar15 = clist->num_rows_inc_padding;
        iVar16 = iVar15 + 1;
        if (iVar16 < 0) {
        ...
        *(float *)((int)*clist->Jstore + iVar15 * 4 + uVar24 * 0x10 + (iVar16 >> 2) * 0xb0 + 0x94) =
             -t2[uVar24];
        iVar15 = clist->num_rows_inc_padding;
        iVar16 = iVar15;
        if (iVar15 < 0) {
        ...
        *(float *)((int)*clist->Jstore + iVar15 * 4 + uVar24 * 0x10 + (iVar16 >> 2) * 0xb0 + 0xa0) =
             -t1[uVar24 + 1];
        iVar15 = clist->num_rows_inc_padding;
        iVar16 = iVar15 + 1;
        if (iVar16 < 0) {
        ...
        uVar23 = uVar24 + 2;
        *(float *)((int)*clist->Jstore + iVar15 * 4 + uVar24 * 0x10 + (iVar16 >> 2) * 0xb0 + 0xa4) =
             -t2[uVar24 + 1];
        uVar24 = uVar23;
      } while (uVar23 < 3);
    }
    *pMVar14 = -3.4028235e+38;
    *pMVar19 = 3.4028235e+38;
    pMVar14[1] = -3.4028235e+38;
    pMVar19[1] = 3.4028235e+38;
    ...
    *pfVar21 = hepsilon * *(float *)params * *(float *)((int)constraint + 0x164);
    pfVar21[1] = hepsilon * *(float *)params * *(float *)((int)constraint + 0x164);
  }
  if (*(int *)((int)constraint + 0x160) == 0) {
                    /* Unresolved local var: int z@[DW_OP_reg7(EDI)] */
    iVar16 = 0;
    do {
      ...
      *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + 8 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10) =
           0;
      iVar2 = clist->num_rows_inc_padding;
      iVar15 = iVar2 + 2;
      if (iVar15 < 0) {
      ...
      *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 0x68)
           = 0;
      iVar2 = clist->num_rows_inc_padding;
      iVar15 = iVar2 + 2;
      if (iVar15 < 0) {
      ...
      *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + (iVar15 >> 2) * 0xb0 + iVar16 * 0x10 + 0x18)
           = 0;
      iVar2 = clist->num_rows_inc_padding;
      iVar15 = iVar2 + 2;
      if (iVar15 < 0) {
      ...
      iVar22 = iVar16 + 2;
      *(undefined4 *)((int)*clist->Jstore + iVar2 * 4 + iVar16 * 0x10 + (iVar15 >> 2) * 0xb0 + 0x78)
           = 0;
      iVar16 = iVar22;
    } while (iVar22 != 6);
    pfVar20[2] = 0.0;
    ...
    *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x38) = t2[0];
    iVar15 = clist->num_rows_inc_padding;
    iVar16 = iVar15 + 2;
    if (iVar16 < 0) {
      iVar16 = iVar15 + 5;
    }
    *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x48) = t2[1];
    iVar15 = clist->num_rows_inc_padding;
    iVar16 = iVar15 + 2;
    if (iVar16 < 0) {
      iVar16 = iVar15 + 5;
    }
    *(MeReal *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x58) = t2[2];
    if (*(int *)((int)constraint + 0xb8) != -1) {
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 2;
      if (iVar16 < 0) {
      ...
      *(float *)((int)*clist->Jstore + iVar15 * 4 + (iVar16 >> 2) * 0xb0 + 0x98) = -t2[0];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 2;
      if (iVar16 < 0) {
        iVar16 = iVar15 + 5;
      }
      *(float *)((int)*clist->Jstore + iVar15 * 4 + 0xa8 + (iVar16 >> 2) * 0xb0) = -t2[1];
      iVar15 = clist->num_rows_inc_padding;
      iVar16 = iVar15 + 2;
      if (iVar16 < 0) {
        iVar16 = iVar15 + 5;
      }
      *(float *)((int)*clist->Jstore + iVar15 * 4 + 0xb8 + (iVar16 >> 2) * 0xb0) = -t2[2];
    }
    pMVar14[2] = -3.4028235e+38;
    pMVar19[2] = 3.4028235e+38;
    pfVar20[2] = -fVar1;
    pfVar17[2] = hepsilon;
    if (hepsilon < 0.0) {
      pfVar17[2] = 0.0;
    }
    pfVar21[2] = hepsilon * *(float *)params * *(float *)((int)constraint + 0x164);
    uVar24 = 3;
  }
  else {
    uVar24 = 2;
  }
  MdtBclEndConstraint(clist,uVar24);
  return;
}
