...
PElement * __regparm1 PElementFind(PElement *root,PElementCompareCB cb,void *k1,void *k2)

{
  undefined4 *puVar1;
  PElementCompareCB cb_00;
  PElement *pPVar2;
  
                    /* Unresolved local var: PElementNode * node@[DW_OP_reg3(EBX)] */
  puVar1 = *(undefined4 **)(cb + 4);
  while( true ) {
    if (puVar1 == (undefined4 *)0x0) {
      return (PElement *)0x0;
                    ...
                    /* Unresolved local var: PElement * ret@[DW_OP_reg0(EAX)]
                       Unresolved local var: PElement * e@[DW_OP_reg6(ESI)] */
    cb_00 = (PElementCompareCB)*puVar1;
    pPVar2 = (PElement *)(*k1)(cb_00,k2);
    if (pPVar2 != (PElement *)0x0) break;
    pPVar2 = PElementFind((PElement *)0x0,cb_00,k1,k2);
    if (pPVar2 != (PElement *)0x0) {
      return pPVar2;
    }
...
void __regparm1 PElementTraverseAll(PElement *root,PElementCB cb,MeBool rootFirst,void *userdata)

{
  undefined4 *puVar1;
  PElementCB cb_00;
  PElement *extraout_EAX;
  undefined4 extraout_EDX;
  undefined4 in_stack_00000010;
  
                    /* Unresolved local var: PElementNode * node@[DW_OP_reg3(EBX)] */
  for (puVar1 = *(undefined4 **)(cb + 4); puVar1 != (undefined4 *)0x0;
      puVar1 = (undefined4 *)puVar1[1]) {
                    /* Unresolved local var: PElement * e@[DW_OP_reg6(ESI)] */
    cb_00 = (PElementCB)*puVar1;
    if (userdata != (void *)0x0) {
      (*(code *)rootFirst)(cb_00,cb,in_stack_00000010,root);
    }
    PElementTraverseAll((PElement *)rootFirst,cb_00,rootFirst,userdata);
    root = extraout_EAX;
    if (userdata == (void *)0x0) {
      root = (PElement *)(*(code *)rootFirst)(cb_00,cb,in_stack_00000010,extraout_EDX);
    }
  }
  return;
}
