 ...
 * source object: /home/ion/tools/karma-lab/allobj/IxBoxCylinder.o
 */
#include "kd_compat.h"
#include "kd_karma.h"
#include "kd_types.h"
...
/*  Prelude for IxBoxCylinder.o — generated by tools/gen_prelude.py.
 *
...
void kd_BoxCylIntersect(lsVec3 **outList,lsTransform *tAB,lsVec3 *inRA,MeReal inRCyl,MeReal inHHCyl, lsVec3 *nPara,lsVec3 *nPerp,lsVec3 *cylAxis,MeReal scale) KD_MANGLED("_Z15BoxCylIntersectRP6lsVec3RK11lsTransformRKS_ffS6_S6_S6_f");
bool kd_OverlapOBBCyl(MeReal *outSep,lsVec3 *outN,MeReal *outPN,lsVec3 **outPos,MeReal inEps, lsVec3 *inROBB,MeReal inRCyl,MeReal inHHCyl,lsTransform *inT12,MeReal scale) KD_MANGLED("_Z13OverlapOBBCylRfR6lsVec3S_RPS0_fRKS0_ffRK11lsTransformf");
MeBool kd_McdBoxCylinderIntersect(McdModelPair *p,McdIntersectResult *result) KD_MANGLED("McdBoxCylinderIntersect");
int kd_McdBoxCylinderSafeTime(McdModelPair *p,MeReal maxTime,McdSafeTimeResult *result) KD_MANGLED("McdBoxCylinderSafeTime");
MeBool kd_McdBoxCylinderRegisterInteraction(McdFramework *frame) KD_MANGLED("McdBoxCylinderRegisterInteraction");
...
/* ---- BoxCylIntersect (exported as kd_BoxCylIntersect, asm label "kd_BoxCylIntersect") ---- */
void kd_BoxCylIntersect(lsVec3 **outList,lsTransform *tAB,lsVec3 *inRA,MeReal inRCyl,MeReal inHHCyl,
...
/* ---- OverlapOBBCyl (exported as kd_OverlapOBBCyl, asm label "kd_OverlapOBBCyl") ---- */
bool kd_OverlapOBBCyl(MeReal *outSep,lsVec3 *outN,MeReal *outPN,lsVec3 **outPos,MeReal inEps,
...
LAB_00012862:
  kd_BoxCylIntersect(outPos,inT12,inROBB,inRCyl,inHHCyl,&nPara,&nPerp,(lsVec3 *)cylAxis,scale);
  plVar15 = *outPos;
LAB_0001289f:
  return plVar15 != plVar17;
}

/* ---- McdBoxCylinderIntersect (exported as kd_McdBoxCylinderIntersect, asm label "McdBoxCylinderIntersect") ---- */
MeBool kd_McdBoxCylinderIntersect(McdModelPair *p,McdIntersectResult *result)

{
  ...
  plVar9 = footprint;
  verts = plVar9;
  bVar2 = kd_OverlapOBBCyl(&separation,&normal,&PN,&verts,fVar13 + fVar12,inROBB,inRCyl,inHHCyl,&tAB,
                        pMVar1->mScale);
  uVar10 = 0;
  if (bVar2) {
...
/* ---- McdBoxCylinderSafeTime (exported as kd_McdBoxCylinderSafeTime, asm label "McdBoxCylinderSafeTime") ---- */
int kd_McdBoxCylinderSafeTime(McdModelPair *p,MeReal maxTime,McdSafeTimeResult *result)
...
/* ---- McdBoxCylinderRegisterInteraction (exported as kd_McdBoxCylinderRegisterInteraction, asm label "McdBoxCylinderRegisterInteraction") ---- */
MeBool kd_McdBoxCylinderRegisterInteraction(McdFramework *frame)

{
  ...
  interactions.intersectFn = kd_McdBoxCylinderIntersect;
  interactions.safetimeFn = kd_McdBoxCylinderSafeTime;
  interactions.cull = 1;
