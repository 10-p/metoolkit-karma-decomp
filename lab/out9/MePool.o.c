...

{
  ...
  if (0 < poolSize) {
    if (alignment == 0) {
      pvVar1 = (*_MeMemoryAPI)(poolSize * structSize);
      ...
      pvVar1 = (*_MeWarning)(poolSize * structSize,alignment);
      (u->u).fixed.createdAligned = 1;
      (u->u).fixed.structArray = pvVar1;
    }
    ppvVar2 = (*_MeMemoryAPI)(poolSize << 2);
...

{
  ...
  if ((u->u).malloc.usedStructs < (u->u).fixed.nextFreeStruct) {
    ...
    if (uVar1 == 0) {
      pvVar2 = (*_MeMemoryAPI)((u->u).malloc.structSize);
    }
    else {
      pvVar2 = (*_MeWarning)((u->u).malloc.structSize,uVar1);
    }
    pvVar3 = (void *)0x0;
    if (pvVar2 != (void *)0x0) {
